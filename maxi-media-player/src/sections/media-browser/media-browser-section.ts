...
import { mdiAccountMusic, mdiFolderStar, mdiFolderStarOutline, mdiPlayBoxMultiple } from '@mdi/js';
    ...
    return html`
      ${config.hideHeader
        ...
        : html`<div class="header">
            ...
            ${onlyFavorites
              ? ''
              : html`<sonos-icon-button .path=${mdiAccountMusic} @click=${this.goToSources} title="Browse by source/account"></sonos-icon-button>
                  <sonos-icon-button .path=${mdiPlayBoxMultiple} @click=${this.goToBrowser} title="Browse Media"></sonos-icon-button>
                  <sonos-icon-button
