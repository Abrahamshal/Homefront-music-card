...
`;function Qt(t,e={}){return(s={})=>{const r=s.size??20,a=s.stroke??"currentColor",o=s.sw??e.sw??1.7;return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${t} /></svg>`}}function jt(t){return(e={})=>{const s=e.size??20,r=e.fill??"currentColor";return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill=${r} stroke="none"><path d=${t} /></svg>`}}const Dt={play:jt("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(t={})=>{const e=t.size??20,s=t.fill??"currentColor";return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${s} stroke="none">
      <rect x="6" y="5" width="4.2" height="14" rx="1.2" />
      <rect x="13.8" y="5" width="4.2" height="14" rx="1.2" />
    </svg>`},prev:jt("M6 5h2v14H6V5zm14 .9v12.2a1 1 0 0 1-1.55.83L9 12.83a1 1 0 0 1 0-1.66l9.45-6.1A1 1 0 0 1 20 5.9z"),next:jt("M18 5h-2v14h2V5zM4 5.9v12.2a1 1 0 0 0 1.55.83L15 12.83a1 1 0 0 0 0-1.66L5.55 5.07A1 1 0 0 0 4 5.9z"),shuffle:Qt("M16 4h4v4 M20 4l-7 7 M4 4l16 16 M16 20h4v-4 M4 20l5-5"),rep:Qt("M4 9V8a3 3 0 0 1 3-3h11l-3-3 M20 15v1a3 3 0 0 1-3 3H6l3 3"),rep1:(t={})=>{const e=t.size??20,s=t.stroke??"currentColor",r=t.sw??1.7;return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill="none" stroke=${s} stroke-width=${r} stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`},queue:Qt("M4 7h11 M4 12h11 M4 17h7 M16 14v6 l3-2"),search:Qt("M11 4a7 7 0 1 0 4.6 12.3L20 20 M11 4a7 7 0 0 1 7 7"),home:Qt("M4 11l8-7 8 7v8a2 2 0 0 1-2 2h-3v-6h-6v6H6a2 2 0 0 1-2-2v-8z"),speaker:Qt("M5 9h3l4-4v14l-4-4H5z M16 8a5 5 0 0 1 0 8 M19 5a9 9 0 0 1 0 14"),group:Qt("M7 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M17 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M3 20c0-3 2.7-5 6-5s4 1 4 1 M14 21c0-2.5 1.5-4 4-4s4 1.5 4 4"),dot3:(t={})=>{const e=t.size??20,s=t.fill??"currentColor";return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${s} stroke="none">
      <circle cx="5" cy="12" r="1.6" />
      <circle cx="12" cy="12" r="1.6" />
      <circle cx="19" cy="12" r="1.6" />
    </svg>`},x:Qt("M6 6l12 12 M18 6L6 18"),chev:Qt("M9 6l6 6-6 6"),chevL:Qt("M15 6l-6 6 6 6"),chevD:Qt("M6 9l6 6 6-6"),plus:Qt("M12 5v14 M5 12h14"),check:Qt("M5 12l4 4 10-10"),drag:(t={})=>{const e=t.size??20,s=t.fill??"currentColor";return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${s} stroke="none">
      <circle cx="9" cy="6" r="1.5" /><circle cx="15" cy="6" r="1.5" />
      <circle cx="9" cy="12" r="1.5" /><circle cx="15" cy="12" r="1.5" />
      <circle cx="9" cy="18" r="1.5" /><circle cx="15" cy="18" r="1.5" />
    </svg>`},trash:Qt("M5 7h14 M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2 M7 7l1 13a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2l1-13"),top:Qt("M12 19V7 M6 13l6-6 6 6 M5 4h14"),playNext:Qt("M5 5l10 7-10 7V5z M19 6v12",{sw:2}),radio:Qt("M4 12a8 8 0 0 1 14-5.5 M6 16a4 4 0 0 1 5-5 M3 20l14-14"),list:Qt("M4 6h16 M4 12h16 M4 18h16"),album:(t={})=>{const e=t.size??20,s=t.stroke??"currentColor",r=t.sw??1.6;return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill="none" stroke=${s} stroke-width=${r} stroke-linecap="round" stroke-linejoin="round">
  ...
  `,t([ut({attribute:!1})],re.prototype,"obj",void 0),t([ut()],re.prototype,"size",void 0),t([ut({type:Number})],re.prototype,"radius",void 0),t([ut({attribute:!1})],re.prototype,"glyph",void 0),t([ut()],re.prototype,"boxShadow",void 0),t([ut({attribute:"image-url"})],re.prototype,"imageUrl",void 0),re=t([ct("hf-album-art")],re);let ae=class extends i{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.color="#fff",this.track="rgba(255,255,255,0.18)",this.trackHeight=4,this.thumb=14,this.ariaLabel="",this._onInput=t=>{const e=Number(t.target.value);this.value=e,this.dispatchEvent(new CustomEvent("hf-input",{detail:e,bubbles:!0,composed:!0}))}}render(){const t=(this.value-this.min)/(this.max-this.min)*100;return this.style.setProperty("--hf-pct",`${t}%`),this.style.setProperty("--hf-color",this.color),this.style.setProperty("--hf-track",this.track),this.style.setProperty("--hf-track-h",`${this.trackHeight}px`),this.style.setProperty("--hf-thumb",`${this.thumb}px`),X`<input
      type="range"
      min=${this.min}
      max=${this.max}
  ...
  `,t([ut({type:Number})],ae.prototype,"value",void 0),t([ut({type:Number})],ae.prototype,"min",void 0),t([ut({type:Number})],ae.prototype,"max",void 0),t([ut()],ae.prototype,"color",void 0),t([ut()],ae.prototype,"track",void 0),t([ut({type:Number,attribute:"track-height"})],ae.prototype,"trackHeight",void 0),t([ut({type:Number})],ae.prototype,"thumb",void 0),t([ut({attribute:"aria-label"})],ae.prototype,"ariaLabel",void 0),ae=t([ct("hf-slider")],ae);let oe=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const t=this.store,e=t.currentTrack,s=t.currentAlbum,r=t.activePlayer,a=t.activeGroup,o=t.groups.filter(t=>!t.isActive&&t.playing).length,n=s.imageUrl;return X`
      <div class="art-wrap">
        <hf-album-art
          .obj=${s}
          size="100%"
      ...
      <div class="transport">
        ...
        >
          ${r.playing?Dt.pause({size:22}):Dt.play({size:22})}
        </button>
        ...
        <button
          ...
          @click=${()=>t.cycleRepeat()}
        >
          ${"one"===r.repeat?Dt.rep1({size:18}):Dt.rep({size:18})}
        </button>
      </div>
      <div class="output">
        <button class="output-main" type="button" @click=${()=>t.setTab("group")}>
          ${Dt.speaker({size:16,stroke:wt})}
  ...
  `,t([ut({attribute:!1})],oe.prototype,"store",void 0),oe=t([ct("hf-player-tab")],oe);const ne=[{id:"playlists",label:"Playlists"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"tracks",label:"Tracks"},{id:"radio",label:"Radio"}],le=[{id:"default",label:"Default (MA order)"},{id:"title_asc",label:"Title A → Z"},{id:"title_desc",label:"Title Z → A"}];let de=class extends i{constructor(){super(...arguments),this._kickedOffRoot=!1,this._sortMode="default",this._sortMenuOpen=!1,this._filterQuery="",this._lastStackDepth=0,this._closeSortMenu=()=>{this._sortMenuOpen&&(this._sortMenuOpen=!1)}}willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}updated(){!this.store?.isHassMode||this._kickedOffRoot||0!==this.store.hassBrowseStack.length||this.store.hassBrowseLoading||(this._kickedOffRoot=!0,this.store.browseRoot());const t=this.store?.hassBrowseStack?.length??0;t!==this._lastStackDepth&&(this._lastStackDepth=t,""!==this._filterQuery&&(this._filterQuery=""))}render(){return this.store?this.store.isHassMode?this._renderHass():X`${this._renderCrumbs()} ${this._renderBody()}`:X``}_renderHass(){const t=this.store.hassBrowseStack,e=t[t.length-1],s=!!e&&(e.children?.length??0)>5;return X`
    ...
    `}_renderControlsBar(){return X`
      <div class="controls-bar">
        <div class="filter-input-wrap">
          ${Dt.search({size:13,stroke:"currentColor"})}
          <input
            class="filter-input"
            type="search"
        ...
        >
          ${Dt.filter({size:12})} ${t=this._sortMode,le.find(e=>e.id===t)?.label.split(" ")[0]??"Default"}
        </button>
    ...
    `;var t}_chooseSort(t){this._sortMode=t,this._sortMenuOpen=!1}_applySort(t){if("default"===this._sortMode)return t;const e=[...t];return"title_asc"===this._sortMode?e.sort((t,e)=>t.title.localeCompare(e.title)):"title_desc"===this._sortMode&&e.sort((t,e)=>e.title.localeCompare(t.title)),e}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._closeSortMenu)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._closeSortMenu)}_renderHassCrumbs(t){return 0===t.length?X``:X`
      <div class="crumbs">
        ${t.map((e,s)=>{const r=s===t.length-1,a=0===s?"Sources":e.title;return X`
            <button
              class="crumb-btn"
              data-current=${r}
            ...
            ${s<t.length-1?X`<span aria-hidden="true">${Dt.chev({size:11})}</span>`:""}
          `})}
      </div>
    `}_renderHassNode(t){const e=t.children??[];if(0===e.length)return X`<div class="hass-empty">No items</div>`;const s=this._applyFilter(e),r=this._applySort(s);return 0===r.length?X`
      ...
      `:X`<div class="body">${this._renderHassList(r)}</div>`}_applyFilter(t){const e=this._filterQuery.trim().toLowerCase();return e?t.filter(t=>t.title.toLowerCase().includes(e)):t}_renderHassList(t){return X`
      <div>
        ${t.map(t=>X`
            <button class="track-row" @click=${()=>this._onHassChildClick(t)}>
              ${t.thumbnail?X`<hf-album-art
                    .obj=${null}
                  ...
                  >
                    ${this._iconForClass(t.media_class)}
                  </div>`}
              <div class="track-meta">
                <div class="track-name">${t.title}</div>
                <div class="track-sub">${t.media_class}</div>
              </div>
              ${t.can_expand?Dt.chev({size:14}):t.can_play?Dt.play({size:14}):""}
            </button>
          `)}
      </div>
    `}_onHassChildClick(t){t.can_expand?this.store.browseInto(t):t.can_play&&this.store.playBrowseNode(t,"replace")}_iconForClass(t){return"track"===t||"music"===t?Dt.note({size:16}):"album"===t?Dt.album({size:16}):"artist"===t?Dt.artist({size:16}):"playlist"===t?Dt.list({size:16}):"radio"===t?Dt.radio({size:16}):Dt.home({size:16})}_renderCrumbs(){const t=this.store.browser.crumbs;return X`
      <div class="crumbs">
    ...
    `}_renderBody(){const{providerId:t,accountId:e,sub:s,detailId:r}=this.store.browser;if(!t)return this._renderProviders();const a=Zt.providerById(t);return a?e?r?this._renderDetail(r):this._renderTypeView(s):this._renderAccounts(a):X``}_renderProviders(){return X`
      <div class="body">
        <div class="section-label">Connected sources</div>
        <div class="stack">
          ${Zt.providers.map(t=>this._renderProviderTile(t))}
        </div>
      </div>
    ...
    `}_renderTypeBody(t){return"playlists"===t?X`
      ...
      `:"artists"===t?X`
        <div>
          ${Zt.artistList.slice(0,12).map((t,e)=>X`
      ...
      `:"tracks"===t?X`
        <div>
          ${Zt.tracks.slice(0,12).map((t,e)=>this._renderTrackRow(t,e+1))}
        </div>
      `:X`
      <div class="stack">
        ${Zt.radioStations.map(t=>X`
            <button class="radio-row">
              <hf-album-art
                .obj=${t}
                size="44"
                radius="10"
                .glyph=${Dt.radio({size:18,stroke:"#fff"})}
              ></hf-album-art>
              <div style="flex:1; min-width:0">
    ...
    `}_renderTrackRow(t,e){const s=Zt.albumById(t.albumId);return X`
    ...
    `}_renderDetail(t){const e=Zt.playlists.find(e=>e.id===t),s=Zt.albums.find(e=>e.id===t),r=e??s;if(!r)return X``;const a=!!e;return X`
      <div>
        <div class="detail-header">
          ...
          <div class="detail-meta">
            ...
            <div class="detail-actions">
              <button class="pill-btn primary">${Dt.play({size:13})} Play</button>
              <button class="pill-btn">${Dt.plus({size:13})} Queue</button>
            </div>
          </div>
        </div>
        <div class="body">
          ${Zt.tracks.slice(0,10).map((t,e)=>this._renderTrackRow(t,e+1))}
        </div>
      </div>
    `}};de.styles=l`
    :host {
  ...
  `,t([ut({attribute:!1})],de.prototype,"store",void 0),t([ft()],de.prototype,"_sortMode",void 0),t([ft()],de.prototype,"_sortMenuOpen",void 0),t([ft()],de.prototype,"_filterQuery",void 0),de=t([ct("hf-browse-tab")],de);const ce=[{id:"all",label:"All"},{id:"tracks",label:"Tracks"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"playlists",label:"Playlists"}],he=["khruangbin","jazz","deep focus","ambient","tycho","discover weekly"],pe=new Set;let ue=class extends i{constructor(){super(...arguments),this._searchTimer=null,this._lastFiredQuery=""}willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimer&&(window.clearTimeout(this._searchTimer),this._searchTimer=null)}_scheduleHassSearch(t,e){null!==this._searchTimer&&window.clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{if(t===this._lastFiredQuery)return;this._lastFiredQuery=t;const s=function(t){switch(t){case"tracks":return["track"];case"albums":return["album"];case"artists":return["artist"];case"playlists":return["playlist"];default:return[]}}(e);this.store.searchMa(t,s,25)},350)}render(){if(!this.store)return X``;if(this.store.isHassMode)return this._renderHass();const t=this.store,e=t.search.query.trim().toLowerCase(),s=t.search.filter,r=e?this._matchesFor(e):null;return X`
    ...
    `}_matchesFor(t){const e=e=>e.toLowerCase().includes(t);return{tracks:Zt.tracks.filter(t=>e(t.name)||e(t.artist)),albums:Zt.albums.filter(t=>e(t.name)||e(t.artist)),artists:Zt.artistList.filter(e),playlists:Zt.playlists.filter(t=>e(t.name))}}_renderResults(t,e){return X`
      <div class="body">
        ${Zt.providers.map(s=>this._renderProviderSection(s,t,e))}
      </div>
      ...
      <div class="section">
        ...
        ${r.length>0?X`
              <div style="margin-bottom:6px">
                ...
                ${r.map(t=>{const e=Zt.albumById(t.albumId);return X`
                    <div class="track-row">
    ...
    `}_renderSuggestions(){return X`
      <div class="suggestions">
        ...
        ${Zt.tracks.slice(0,4).map(t=>{const e=Zt.albumById(t.albumId);return X`
            <div class="track-row">
              <hf-album-art .obj=${e} size="36" radius="6"></hf-album-art>
              <div class="row-meta">
                <div class="row-name">${t.name}</div>
    ...
    `}_renderHassResultRow(t){const e=t,s=fe(e.title)??fe(e.name)??"(untitled)",r=[],a=fe(e.artist)??fe(e.artists);a&&r.push(a);const o=fe(e.album);o&&o!==s&&r.push(o);const n=fe(e.provider)??fe(e.provider_mappings);n&&r.push(n);const l=r.join(" · "),d=me(e),c="number"==typeof e.duration?e.duration:"number"==typeof e.duration_seconds?e.duration_seconds:void 0;return pe.has(e.uri??s)||(pe.add(e.uri??s),pe.size<6&&console.debug("[homefront-music-card] search row extract:",{title:s,artistStr:a,albumStr:o,image:d,rawArtist:e.artist,rawArtists:e.artists,rawAlbum:e.album,rawMetadata:e.metadata})),X`
    ...
    `}};function fe(t){if("string"==typeof t){const e=t.trim();if(!e)return;if("[object Object]"===e)return;return e}if(Array.isArray(t)&&t.length>0)return fe(t[0]);if(t&&"object"==typeof t){const e=t;return fe(e.name)??fe(e.title)??fe(e.display_name)??void 0}}function me(t){const e=t=>{if("string"==typeof t&&t&&("undefined"==typeof location||"https:"!==location.protocol||!t.startsWith("http:")))return t},s=e(t.image_url)??e(t.thumbnail)??e(t.image);if(s)return s;const r=t.metadata,a=r?.images?.[0];if(a){const t=e(a.path)??e(a.url);if(t)return t}for(const e of["album","artist","artists"]){const s=t[e];if(Array.isArray(s)&&s.length>0){const t=me(s[0]);if(t)return t}else if(s&&"object"==typeof s){const t=me(s);if(t)return t}}}ue.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,t([ut({attribute:!1})],ue.prototype,"store",void 0),ue=t([ct("hf-search-tab")],ue);let ve=class extends i{constructor(){super(...arguments),this.rowHeight=56,this.actionBg="#e0413a",this._dx=0,this._dragging=!1,this._startX=null,this._startDx=0,this._onDown=t=>{const e="touches"in t?t.touches[0].clientX:t.clientX;this._startX=e,this._startDx=this._dx,this._dragging=!0},this._onMove=t=>{if(null===this._startX)return;const e="touches"in t?t.touches[0].clientX:t.clientX;let s=this._startDx+(e-this._startX);s>0&&(s=0),s<-110&&(s=-110),this._dx=s},this._onUp=()=>{this._startX=null,this._dragging=!1,this._dx=this._dx<-64?-92:0},this._fireDelete=()=>{this.dispatchEvent(new CustomEvent("hf-delete",{bubbles:!0,composed:!0})),this._dx=0}}render(){return X`
      <div
        class="action"
  ...
  `,t([ut({type:Number})],ve.prototype,"rowHeight",void 0),t([ut()],ve.prototype,"actionBg",void 0),t([ut({attribute:!1})],ve.prototype,"icon",void 0),t([ft()],ve.prototype,"_dx",void 0),t([ft()],ve.prototype,"_dragging",void 0),ve=t([ct("hf-swipe-row")],ve);let ge=class extends i{constructor(){super(...arguments),this.items=[],this.rowHeight=56,this.renderRow=()=>X``,this._dragIdx=null,this._hoverIdx=null,this._startY=0,this._onMove=t=>{if(null===this._dragIdx)return;const e=("touches"in t?t.touches[0].clientY:t.clientY)-this._startY,s=Math.round(this._dragIdx+e/this.rowHeight);this._hoverIdx=Math.max(0,Math.min(this.items.length-1,s))},this._onUp=()=>{null!==this._dragIdx&&null!==this._hoverIdx&&this._hoverIdx!==this._dragIdx&&this.dispatchEvent(new CustomEvent("hf-reorder",{detail:{from:this._dragIdx,to:this._hoverIdx},bubbles:!0,composed:!0})),this._dragIdx=null,this._hoverIdx=null,window.removeEventListener("mousemove",this._onMove),window.removeEventListener("mouseup",this._onUp),window.removeEventListener("touchmove",this._onMove),window.removeEventListener("touchend",this._onUp)}}createRenderRoot(){return this}render(){const t=this._positions();return X`
      <div
    ...
    `}_renderRow(t,e){const s=this.store,r=Zt.trackById(t.id);if(!r)return X``;const a=Zt.albumById(r.albumId),o=s.selectedTracks.has(t.idxInQueue);return X`
      <hf-swipe-row
        .rowHeight=${56}
    ...
    `}_toggleSelectHass(t){const e=this.store.selectedTracks,s=new Set(e);s.has(t)?s.delete(t):s.add(t),this.store.setSelectedTracks(s)}_bulkRemoveHass(){const t=this.store.selectedTracks;this.store.removeQueueItems(new Set(t))}};be.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,t([ut({attribute:!1})],be.prototype,"store",void 0),be=t([ct("hf-queue-tab")],be);let xe=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const t=this.store.groups,e=t.filter(t=>!t.isIdle),s=t.filter(t=>t.isIdle);return X`
      <div class="header">
    ...
    `}_renderGroupCard(t){const e=t.player?Zt.trackById(t.player.queue[t.player.currentIdx]??""):void 0,s=e?Zt.albumById(e.albumId):void 0,r=t.player?.groupVolume??t.lead.volume;return X`
      <div class="group-card" data-active=${t.isActive}>
        <div class="group-head">
          ${s?X`<hf-album-art .obj=${s} size="46" radius="9"></hf-album-art>`:X`<div class="group-art">${Dt.speaker({size:18})}</div>`}
          ...
          <div class="group-actions">
            ...
            >
              ${t.playing?Dt.pause({size:14}):Dt.play({size:14})}
            </button>
          </div>
        </div>
    ...
    `}_renderIdleRow(t){const e=t.lead;return X`
      <div class="idle-row">
        <div class="idle-icon">${Dt.speaker({size:14})}</div>
        <div class="idle-info">
  ...
  `,t([ut({attribute:!1})],xe.prototype,"store",void 0),xe=t([ct("hf-output-tab")],xe);const ye=l`
  .hf-pip {
    display: inline-flex;
    align-items: flex-end;
    gap: 1.5px;
...
`;let _e=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const t=this.store.groups;return X`
      <div class="rail">
  ...
  `}(e):Dt.speaker({size:11,stroke:"currentColor"})}
  ...
  `,t([ut({attribute:!1})],we.prototype,"store",void 0),t([ft()],we.prototype,"_draft",void 0),we=t([ct("hf-group-sheet")],we);const $e=[{key:"hasMA",name:"Music Assistant",why:"Browses libraries (Spotify, Apple Music, Tidal, …), drives playback, and surfaces now-playing metadata.",hint:"Install the Music Assistant add-on, then add the integration under Settings → Devices & Services.",link:"https://music-assistant.io"},{key:"hasQueueActions",name:"Music Assistant Queue Actions (mass_queue)",why:"Adds queue manipulation services (reorder, remove, clear) the card uses on the Queue tab. Registers services under the mass_queue domain.",hint:'Install via HACS — "Music Assistant Queue Actions" by droans — then add it under Settings → Devices & Services.',link:"https://github.com/droans/mass_queue"},{key:"hasWiim",name:"WiiM Audio (LinkPlay)",why:"Provides WiiM-native Linkplay grouping. The card uses this for all multi-room sync, never MA grouping.",hint:'Install via HACS — "WiiM Audio Integration for Home Assistant" by mjcumming — then add each device under Settings → Devices & Services.',link:"https://github.com/mjcumming/wiim"}];let ke=class extends i{render(){if(!this.status)return X``;const t=$e.filter(t=>!this.status[t.key]),e=t.length;return X`
    ...
    `}_renderRow(t){const e=this.status[t.key];return X`
      <div class="row" data-state=${e?"ok":"missing"}>
        <div class="row-status">
          ${e?Dt.check({size:14,sw:2.4}):Dt.plus({size:14,sw:2.4})}
        </div>
        <div class="row-body">
          <div class="row-name">${t.name}</div>
    ...
    `],t([ut({attribute:!1})],ke.prototype,"status",void 0),ke=t([ct("hf-setup-help")],ke);let Se=class extends i{constructor(){super(...arguments),this._pickerInitTriggered=!1}setConfig(t){this._config={...t}}updated(){!this._pickerInitTriggered&&this.hass&&this._config&&!customElements.get("ha-entity-picker")&&(this._pickerInitTriggered=!0,this._loadEntityPicker())}async _loadEntityPicker(){try{const t=await(window.loadCardHelpers?.());if(!t?.createCardElement)return;const e=await t.createCardElement({type:"entities",entities:[]}),s=e?.constructor;await(s?.getConfigElement?.())}catch(t){console.warn("[homefront-music-card] failed to load ha-entity-picker:",t)}finally{this.requestUpdate()}}render(){return this._config?X`
  ...
  `,t([ut({attribute:!1})],Se.prototype,"hass",void 0),t([ft()],Se.prototype,"_config",void 0),Se=t([ct("hf-card-editor")],Se);let ze=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){return this.store&&0!==this.store.toasts.length?X`
      ${this.store.toasts.map(t=>X`
        ...
        `)}
    `:X``}_iconFor(t){return"error"===t?Dt.x({size:14,sw:2.4}):"warning"===t?Dt.filter({size:14}):Dt.note({size:14})}};ze.styles=l`
    :host {
      position: absolute;
      left: 0;
      right: 0;
  ...
  `,t([ut({attribute:!1})],ze.prototype,"store",void 0),ze=t([ct("hf-toast-bar")],ze),window.customCards=window.customCards||[],window.customCards.push({type:"homefront-music-card",name:"Homefront Music Card",description:"Music Assistant + WiiM multi-room controller",preview:!1});const Me=[{id:"player",label:"Player",icon:"play"},{id:"browser",label:"Browse",icon:"home"},{id:"search",label:"Search",icon:"search"},{id:"queue",label:"Queue",icon:"queue"},{id:"group",label:"Output",icon:"speaker"}];let Ae=class extends i{constructor(){super(),this.editMode=!1,this._store=new Store,this._openCardEditor=t=>{t.stopPropagation();const e=this._findCardPath(),s={};e&&(s.path=e);for(const t of["show-edit-card","ll-edit-card","ll-show-edit-card"])this.dispatchEvent(new CustomEvent(t,{detail:s,bubbles:!0,composed:!0}))},new StoreController(this,this._store)}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t,this._store.setConfig(t),"panel"===t.layout?this.setAttribute("data-layout","panel"):this.removeAttribute("data-layout"),t.accent_color?(this.style.setProperty("--hf-accent",t.accent_color),this.style.setProperty("--hf-accent-text",function(t){const e=t.trim().replace(/^#/,"");if(3!==e.length&&6!==e.length)return"#fff";const s=3===e.length?e.split("").map(t=>t+t).join(""):e,r=parseInt(s.slice(0,2),16),a=parseInt(s.slice(2,4),16),o=parseInt(s.slice(4,6),16);if([r,a,o].some(t=>Number.isNaN(t)))return"#fff";const n=(.2126*r+.7152*a+.0722*o)/255;return n>.55?"#111":"#fff"}(t.accent_color))):(this.style.removeProperty("--hf-accent"),this.style.removeProperty("--hf-accent-text"));const e=t.density??"regular";this.setAttribute("data-density",e);const s=t.theme??"dark";this.setAttribute("data-theme",s)}willUpdate(t){t.has("hass")&&this.hass&&(this._integrationStatus=function(t){const e=t.services??{},s=t.states??{},r=[],a=e.music_assistant??{},o=e.mass_queue??{},n=e.wiim??{},l=!!a.play_media;r.push({target:"MA",label:"service music_assistant.play_media",matched:l});const d=["get_queue_items","remove_queue_item","move_queue_item_up","play_queue_item","clear_queue_from_here"],c=d.find(t=>!!o[t]),h=!!c;r.push({target:"QueueActions",label:`mass_queue domain has any of ${d.join(", ")}`,matched:h});const p=Object.keys(o);p.length>0&&r.push({target:"QueueActions",label:`mass_queue domain services found: ${p.slice(0,6).join(", ")}${p.length>6?"…":""}`,matched:!0});const u=["play_preset","play_url","set_eq","get_queue"],f=u.find(t=>!!n[t]),m=!!f;r.push({target:"WiiM",label:`wiim domain has any of ${u.join(", ")}`,matched:m});const v=Object.keys(n);v.length>0&&r.push({target:"WiiM",label:`wiim domain services found: ${v.slice(0,6).join(", ")}${v.length>6?"…":""}`,matched:!0});const g=Object.values(s).some(t=>{if(!t.entity_id.startsWith("media_player."))return!1;const e=t.attributes.group_role;return"master"===e||"slave"===e||"solo"===e});r.push({target:"WiiM",label:"any media_player.* attribute group_role is master/slave/solo",matched:g});const b=m||g;return{hasMA:l,hasQueueActions:h,hasWiim:b,allPresent:l&&h&&b,diagnostics:r}}(this.hass),this._integrationStatus.allPresent&&this._store.setHass(this.hass))}getCardSize(){return 12}static getConfigElement(){return document.createElement("hf-card-editor")}static getStubConfig(){return{type:"custom:homefront-music-card"}}disconnectedCallback(){super.disconnectedCallback(),this._store.dispose()}render(){return this._integrationStatus&&!this._integrationStatus.allPresent?X`<hf-setup-help .status=${this._integrationStatus}></hf-setup-help>`:X`
    ...
    `}_renderTitle(){const t=this._config?.zones?.length??0,e=this._store.groups.filter(t=>t.playing).length,s=t>0?` · ${t} zone${1===t?"":"s"}`:" · mock";return X`
      <div class="title-row">
        <span class="title-icon">${Dt.note({size:14})}</span>
    ...
    `],t([ut({attribute:!1})],Ae.prototype,"hass",void 0),t([ut({attribute:!1})],Ae.prototype,"editMode",void 0),t([ft()],Ae.prototype,"_config",void 0),t([ft()],Ae.prototype,"_integrationStatus",void 0),Ae=t([ct("homefront-music-card")],Ae);export{Ae as HomefrontMusicCard};
