...
`;function Dt(t,e={}){return(s={})=>{const r=s.size??20,a=s.stroke??"currentColor",o=s.sw??e.sw??1.7;return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${t} /></svg>`}}function Nt(t){return(e={})=>{const s=e.size??20,r=e.fill??"currentColor";return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill=${r} stroke="none"><path d=${t} /></svg>`}}const Qt={play:Nt("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(t={})=>{const e=t.size??20,s=t.fill??"currentColor";return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${s} stroke="none">
      <rect x="6" y="5" width="4.2" height="14" rx="1.2" />
      <rect x="13.8" y="5" width="4.2" height="14" rx="1.2" />
    </svg>`},prev:Nt("M6 5h2v14H6V5zm14 .9v12.2a1 1 0 0 1-1.55.83L9 12.83a1 1 0 0 1 0-1.66l9.45-6.1A1 1 0 0 1 20 5.9z"),next:Nt("M18 5h-2v14h2V5zM4 5.9v12.2a1 1 0 0 0 1.55.83L15 12.83a1 1 0 0 0 0-1.66L5.55 5.07A1 1 0 0 0 4 5.9z"),shuffle:Dt("M16 4h4v4 M20 4l-7 7 M4 4l16 16 M16 20h4v-4 M4 20l5-5"),rep:Dt("M4 9V8a3 3 0 0 1 3-3h11l-3-3 M20 15v1a3 3 0 0 1-3 3H6l3 3"),rep1:(t={})=>{const e=t.size??20,s=t.stroke??"currentColor",r=t.sw??1.7;return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill="none" stroke=${s} stroke-width=${r} stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`},queue:Dt("M4 7h11 M4 12h11 M4 17h7 M16 14v6 l3-2"),search:Dt("M11 4a7 7 0 1 0 4.6 12.3L20 20 M11 4a7 7 0 0 1 7 7"),home:Dt("M4 11l8-7 8 7v8a2 2 0 0 1-2 2h-3v-6h-6v6H6a2 2 0 0 1-2-2v-8z"),speaker:Dt("M5 9h3l4-4v14l-4-4H5z M16 8a5 5 0 0 1 0 8 M19 5a9 9 0 0 1 0 14"),group:Dt("M7 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M17 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M3 20c0-3 2.7-5 6-5s4 1 4 1 M14 21c0-2.5 1.5-4 4-4s4 1.5 4 4"),dot3:(t={})=>{const e=t.size??20,s=t.fill??"currentColor";return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${s} stroke="none">
      <circle cx="5" cy="12" r="1.6" />
      <circle cx="12" cy="12" r="1.6" />
      <circle cx="19" cy="12" r="1.6" />
    </svg>`},x:Dt("M6 6l12 12 M18 6L6 18"),chev:Dt("M9 6l6 6-6 6"),chevL:Dt("M15 6l-6 6 6 6"),chevD:Dt("M6 9l6 6 6-6"),plus:Dt("M12 5v14 M5 12h14"),check:Dt("M5 12l4 4 10-10"),drag:(t={})=>{const e=t.size??20,s=t.fill??"currentColor";return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${s} stroke="none">
      <circle cx="9" cy="6" r="1.5" /><circle cx="15" cy="6" r="1.5" />
      <circle cx="9" cy="12" r="1.5" /><circle cx="15" cy="12" r="1.5" />
      <circle cx="9" cy="18" r="1.5" /><circle cx="15" cy="18" r="1.5" />
    </svg>`},trash:Dt("M5 7h14 M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2 M7 7l1 13a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2l1-13"),top:Dt("M12 19V7 M6 13l6-6 6 6 M5 4h14"),playNext:Dt("M5 5l10 7-10 7V5z M19 6v12",{sw:2}),radio:Dt("M4 12a8 8 0 0 1 14-5.5 M6 16a4 4 0 0 1 5-5 M3 20l14-14"),list:Dt("M4 6h16 M4 12h16 M4 18h16"),album:(t={})=>{const e=t.size??20,s=t.stroke??"currentColor",r=t.sw??1.6;return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill="none" stroke=${s} stroke-width=${r} stroke-linecap="round" stroke-linejoin="round">
      ...
      <div>
        ${t.map(t=>{const e=ce(t.title)||"(untitled)",s=ce(t.media_class),r=ce(t.thumbnail);return X`
            <button class="track-row" @click=${()=>this._onHassChildClick(t)}>
              ...
              ${t.can_expand?Qt.chev({size:14}):t.can_play?Qt.play({size:14}):""}
            </button>
          `})}
      </div>
    `}_onHassChildClick(t){t.can_expand?this.store.browseInto(t):t.can_play&&this.store.playBrowseNode(t,"replace")}_iconForClass(t){return"track"===t||"music"===t?Qt.note({size:16}):"album"===t?Qt.album({size:16}):"artist"===t?Qt.artist({size:16}):"playlist"===t?Qt.list({size:16}):"radio"===t?Qt.radio({size:16}):Qt.home({size:16})}_renderCrumbs(){const t=this.store.browser.crumbs;return X`
      <div class="crumbs">
