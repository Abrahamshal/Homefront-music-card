...
`;function Ie(e,t={}){return(s={})=>{const r=s.size??20,a=s.stroke??"currentColor",o=s.sw??t.sw??1.7;return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${e} /></svg>`}}function Ce(e){return(t={})=>{const s=t.size??20,r=t.fill??"currentColor";return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill=${r} stroke="none"><path d=${e} /></svg>`}}const Pe={play:Ce("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(e={})=>{const t=e.size??20,s=e.fill??"currentColor";return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill=${s} stroke="none">
  ...
  `,e([ue({attribute:!1})],Qe.prototype,"obj",void 0),e([ue()],Qe.prototype,"size",void 0),e([ue({type:Number})],Qe.prototype,"radius",void 0),e([ue({attribute:!1})],Qe.prototype,"glyph",void 0),e([ue()],Qe.prototype,"boxShadow",void 0),e([ue({attribute:"image-url"})],Qe.prototype,"imageUrl",void 0),Qe=e([ce("hf-album-art")],Qe);let De=class extends i{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.color="#fff",this.track="rgba(255,255,255,0.18)",this.trackHeight=4,this.thumb=14,this.ariaLabel="",this._onInput=e=>{const t=Number(e.target.value);this.value=t,this.dispatchEvent(new CustomEvent("hf-input",{detail:t,bubbles:!0,composed:!0}))}}render(){const e=(this.value-this.min)/(this.max-this.min)*100;return this.style.setProperty("--hf-pct",`${e}%`),this.style.setProperty("--hf-color",this.color),this.style.setProperty("--hf-track",this.track),this.style.setProperty("--hf-track-h",`${this.trackHeight}px`),this.style.setProperty("--hf-thumb",`${this.thumb}px`),X`<input
      type="range"
      min=${this.min}
      max=${this.max}
  ...
  `,e([ue({type:Number})],De.prototype,"value",void 0),e([ue({type:Number})],De.prototype,"min",void 0),e([ue({type:Number})],De.prototype,"max",void 0),e([ue()],De.prototype,"color",void 0),e([ue()],De.prototype,"track",void 0),e([ue({type:Number,attribute:"track-height"})],De.prototype,"trackHeight",void 0),e([ue({type:Number})],De.prototype,"thumb",void 0),e([ue({attribute:"aria-label"})],De.prototype,"ariaLabel",void 0),De=e([ce("hf-slider")],De);let Fe=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store,t=e.currentTrack,s=e.currentAlbum,r=e.activePlayer,a=e.activeGroup,o=e.groups.filter(e=>!e.isActive&&e.playing).length,n=s.imageUrl;return X`
      <div class="art-wrap">
        <hf-album-art
          .obj=${s}
          size="100%"
  ...
  `,e([ue({attribute:!1})],Fe.prototype,"store",void 0),Fe=e([ce("hf-player-tab")],Fe);const We=[{id:"playlists",label:"Playlists"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"tracks",label:"Tracks"},{id:"radio",label:"Radio"}],Ge=[{id:"default",label:"Default (MA order)"},{id:"title_asc",label:"Title A → Z"},{id:"title_desc",label:"Title Z → A"}];let Ve=class extends i{constructor(){super(...arguments),this._kickedOffRoot=!1,this._sortMode="default",this._sortMenuOpen=!1,this._closeSortMenu=()=>{this._sortMenuOpen&&(this._sortMenuOpen=!1)}}willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}updated(){!this.store?.isHassMode||this._kickedOffRoot||0!==this.store.hassBrowseStack.length||this.store.hassBrowseLoading||(this._kickedOffRoot=!0,this.store.browseRoot())}render(){return this.store?this.store.isHassMode?this._renderHass():X`${this._renderCrumbs()} ${this._renderBody()}`:X``}_renderHass(){const e=this.store.hassBrowseStack,t=e[e.length-1];return X`
    ...
    `}_renderSortBar(){return X`
      <div class="sort-bar">
        ...
        >
          ${Pe.filter({size:12})} Sort: ${e=this._sortMode,Ge.find(t=>t.id===e)?.label.split(" ")[0]??"Default"}
        </button>
  ...
  `,e([ue({attribute:!1})],Ve.prototype,"store",void 0),e([me()],Ve.prototype,"_sortMode",void 0),e([me()],Ve.prototype,"_sortMenuOpen",void 0),Ve=e([ce("hf-browse-tab")],Ve);const Ke=[{id:"all",label:"All"},{id:"tracks",label:"Tracks"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"playlists",label:"Playlists"}],Ye=["khruangbin","jazz","deep focus","ambient","tycho","discover weekly"];let Je=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store,t=e.search.query.trim().toLowerCase(),s=e.search.filter,r=t?this._matchesFor(t):null;return X`
      <div class="top">
  ...
  `,e([ue({attribute:!1})],Je.prototype,"store",void 0),Je=e([ce("hf-search-tab")],Je);let Xe=class extends i{constructor(){super(...arguments),this.rowHeight=56,this.actionBg="#e0413a",this._dx=0,this._dragging=!1,this._startX=null,this._startDx=0,this._onDown=e=>{const t="touches"in e?e.touches[0].clientX:e.clientX;this._startX=t,this._startDx=this._dx,this._dragging=!0},this._onMove=e=>{if(null===this._startX)return;const t="touches"in e?e.touches[0].clientX:e.clientX;let s=this._startDx+(t-this._startX);s>0&&(s=0),s<-110&&(s=-110),this._dx=s},this._onUp=()=>{this._startX=null,this._dragging=!1,this._dx=this._dx<-64?-92:0},this._fireDelete=()=>{this.dispatchEvent(new CustomEvent("hf-delete",{bubbles:!0,composed:!0})),this._dx=0}}render(){return X`
      <div
        class="action"
  ...
  `,e([ue({type:Number})],Xe.prototype,"rowHeight",void 0),e([ue()],Xe.prototype,"actionBg",void 0),e([ue({attribute:!1})],Xe.prototype,"icon",void 0),e([me()],Xe.prototype,"_dx",void 0),e([me()],Xe.prototype,"_dragging",void 0),Xe=e([ce("hf-swipe-row")],Xe);let Ze=class extends i{constructor(){super(...arguments),this.items=[],this.rowHeight=56,this.renderRow=()=>X``,this._dragIdx=null,this._hoverIdx=null,this._startY=0,this._onMove=e=>{if(null===this._dragIdx)return;const t=("touches"in e?e.touches[0].clientY:e.clientY)-this._startY,s=Math.round(this._dragIdx+t/this.rowHeight);this._hoverIdx=Math.max(0,Math.min(this.items.length-1,s))},this._onUp=()=>{null!==this._dragIdx&&null!==this._hoverIdx&&this._hoverIdx!==this._dragIdx&&this.dispatchEvent(new CustomEvent("hf-reorder",{detail:{from:this._dragIdx,to:this._hoverIdx},bubbles:!0,composed:!0})),this._dragIdx=null,this._hoverIdx=null,window.removeEventListener("mousemove",this._onMove),window.removeEventListener("mouseup",this._onUp),window.removeEventListener("touchmove",this._onMove),window.removeEventListener("touchend",this._onUp)}}createRenderRoot(){return this}render(){const e=this._positions();return X`
      <div
    ...
    `}_toggleSelectHass(e){const t=this.store.selectedTracks,s=new Set(t);s.has(e)?s.delete(e):s.add(e),this.store.setSelectedTracks(s)}_bulkRemoveHass(){const e=this.store.selectedTracks;this.store.removeQueueItems(new Set(e))}};et.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([ue({attribute:!1})],et.prototype,"store",void 0),et=e([ce("hf-queue-tab")],et);let tt=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups,t=e.filter(e=>!e.isIdle),s=e.filter(e=>e.isIdle);return X`
      <div class="header">
  ...
  `,e([ue({attribute:!1})],tt.prototype,"store",void 0),tt=e([ce("hf-output-tab")],tt);const it=l`
  .hf-pip {
    display: inline-flex;
    align-items: flex-end;
    gap: 1.5px;
...
`;let st=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups;return X`
      <div class="rail">
  ...
  `,e([ue({attribute:!1})],rt.prototype,"store",void 0),e([me()],rt.prototype,"_draft",void 0),rt=e([ce("hf-group-sheet")],rt);const at=[{key:"hasMA",name:"Music Assistant",why:"Browses libraries (Spotify, Apple Music, Tidal, …), drives playback, and surfaces now-playing metadata.",hint:"Install the Music Assistant add-on, then add the integration under Settings → Devices & Services.",link:"https://music-assistant.io"},{key:"hasQueueActions",name:"Music Assistant Queue Actions (mass_queue)",why:"Adds queue manipulation services (reorder, remove, clear) the card uses on the Queue tab. Registers services under the mass_queue domain.",hint:'Install via HACS — "Music Assistant Queue Actions" by droans — then add it under Settings → Devices & Services.',link:"https://github.com/droans/mass_queue"},{key:"hasWiim",name:"WiiM Audio (LinkPlay)",why:"Provides WiiM-native Linkplay grouping. The card uses this for all multi-room sync, never MA grouping.",hint:'Install via HACS — "WiiM Audio Integration for Home Assistant" by mjcumming — then add each device under Settings → Devices & Services.',link:"https://github.com/mjcumming/wiim"}];let ot=class extends i{render(){if(!this.status)return X``;const e=at.filter(e=>!this.status[e.key]),t=e.length;return X`
    ...
    `}_renderActiveTab(){switch(this._store.tab){case"player":return X`<hf-player-tab .store=${this._store}></hf-player-tab>`;case"browser":return X`<hf-browse-tab .store=${this._store}></hf-browse-tab>`;case"search":return X`<hf-search-tab .store=${this._store}></hf-search-tab>`;case"queue":return X`<hf-queue-tab .store=${this._store}></hf-queue-tab>`;case"group":return X`<hf-output-tab .store=${this._store}></hf-output-tab>`}}_renderTabBar(){return X`
      <div class="tab-bar" role="tablist">
        ${nt.map(e=>{const t=this._store.tab===e.id;return X`
            <button
              class="tab"
              role="tab"
              aria-selected=${t}
    ...
    `],e([ue({attribute:!1})],lt.prototype,"hass",void 0),e([me()],lt.prototype,"_config",void 0),e([me()],lt.prototype,"_integrationStatus",void 0),lt=e([ce("homefront-music-card")],lt);export{lt as HomefrontMusicCard};
