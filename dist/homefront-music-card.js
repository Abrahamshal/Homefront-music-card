...
`;function Ne(e,t={}){return(s={})=>{const r=s.size??20,a=s.stroke??"currentColor",o=s.sw??t.sw??1.7;return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${e} /></svg>`}}function je(e){return(t={})=>{const s=t.size??20,r=t.fill??"currentColor";return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill=${r} stroke="none"><path d=${e} /></svg>`}}const De={play:je("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(e={})=>{const t=e.size??20,s=e.fill??"currentColor";return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill=${s} stroke="none">
  ...
  `,e([ue({attribute:!1})],ct.prototype,"store",void 0),e([fe()],ct.prototype,"_sortMode",void 0),e([fe()],ct.prototype,"_sortMenuOpen",void 0),e([fe()],ct.prototype,"_filterQuery",void 0),ct=e([ce("hf-browse-tab")],ct);const ht=[{id:"all",label:"All"},{id:"tracks",label:"Tracks"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"playlists",label:"Playlists"}],pt=["khruangbin","jazz","deep focus","ambient","tycho","discover weekly"],ut=new Set;let ft=class extends i{constructor(){super(...arguments),this._searchTimer=null,this._lastFiredQuery=""}willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimer&&(window.clearTimeout(this._searchTimer),this._searchTimer=null)}_scheduleHassSearch(e,t){null!==this._searchTimer&&window.clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{if(e===this._lastFiredQuery)return;this._lastFiredQuery=e;const s=function(e){switch(e){case"tracks":return["track"];case"albums":return["album"];case"artists":return["artist"];case"playlists":return["playlist"];default:return[]}}(t);this.store.searchMa(e,s,25)},350)}render(){if(!this.store)return X``;if(this.store.isHassMode)return this._renderHass();const e=this.store,t=e.search.query.trim().toLowerCase(),s=e.search.filter,r=t?this._matchesFor(t):null;return X`
    ...
    `}_renderHassResultRow(e){const t=e,s=mt(t.title)??mt(t.name)??"(untitled)",r=[],a=mt(t.artist)??mt(t.artists);a&&r.push(a);const o=mt(t.album);o&&o!==s&&r.push(o);const n=mt(t.provider)??mt(t.provider_mappings);n&&r.push(n);const l=r.join(" · "),d=vt(t),c="number"==typeof t.duration?t.duration:"number"==typeof t.duration_seconds?t.duration_seconds:void 0;return ut.has(t.uri??s)||(ut.add(t.uri??s),ut.size<6&&console.debug("[homefront-music-card] search row extract:",{title:s,artistStr:a,albumStr:o,image:d,rawArtist:t.artist,rawArtists:t.artists,rawAlbum:t.album,rawMetadata:t.metadata})),X`
    ...
    `}};function mt(e){if("string"==typeof e){const t=e.trim();if(!t)return;if("[object Object]"===t)return;return t}if(Array.isArray(e)&&e.length>0)return mt(e[0]);if(e&&"object"==typeof e){const t=e;return mt(t.name)??mt(t.title)??mt(t.display_name)??void 0}}function vt(e){const t=e=>{if("string"==typeof e&&e&&("undefined"==typeof location||"https:"!==location.protocol||!e.startsWith("http:")))return e},s=t(e.image_url)??t(e.thumbnail)??t(e.image);if(s)return s;const r=e.metadata,a=r?.images?.[0];if(a){const e=t(a.path)??t(a.url);if(e)return e}for(const t of["album","artist","artists"]){const s=e[t];if(Array.isArray(s)&&s.length>0){const e=vt(s[0]);if(e)return e}else if(s&&"object"==typeof s){const e=vt(s);if(e)return e}}}ft.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([ue({attribute:!1})],ft.prototype,"store",void 0),ft=e([ce("hf-search-tab")],ft);let gt=class extends i{constructor(){super(...arguments),this.rowHeight=56,this.actionBg="#e0413a",this._dx=0,this._dragging=!1,this._startX=null,this._startDx=0,this._onDown=e=>{const t="touches"in e?e.touches[0].clientX:e.clientX;this._startX=t,this._startDx=this._dx,this._dragging=!0},this._onMove=e=>{if(null===this._startX)return;const t="touches"in e?e.touches[0].clientX:e.clientX;let s=this._startDx+(t-this._startX);s>0&&(s=0),s<-110&&(s=-110),this._dx=s},this._onUp=()=>{this._startX=null,this._dragging=!1,this._dx=this._dx<-64?-92:0},this._fireDelete=()=>{this.dispatchEvent(new CustomEvent("hf-delete",{bubbles:!0,composed:!0})),this._dx=0}}render(){return X`
      <div
        class="action"
  ...
  `,e([ue({type:Number})],gt.prototype,"rowHeight",void 0),e([ue()],gt.prototype,"actionBg",void 0),e([ue({attribute:!1})],gt.prototype,"icon",void 0),e([fe()],gt.prototype,"_dx",void 0),e([fe()],gt.prototype,"_dragging",void 0),gt=e([ce("hf-swipe-row")],gt);let bt=class extends i{constructor(){super(...arguments),this.items=[],this.rowHeight=56,this.renderRow=()=>X``,this._dragIdx=null,this._hoverIdx=null,this._startY=0,this._onMove=e=>{if(null===this._dragIdx)return;const t=("touches"in e?e.touches[0].clientY:e.clientY)-this._startY,s=Math.round(this._dragIdx+t/this.rowHeight);this._hoverIdx=Math.max(0,Math.min(this.items.length-1,s))},this._onUp=()=>{null!==this._dragIdx&&null!==this._hoverIdx&&this._hoverIdx!==this._dragIdx&&this.dispatchEvent(new CustomEvent("hf-reorder",{detail:{from:this._dragIdx,to:this._hoverIdx},bubbles:!0,composed:!0})),this._dragIdx=null,this._hoverIdx=null,window.removeEventListener("mousemove",this._onMove),window.removeEventListener("mouseup",this._onUp),window.removeEventListener("touchmove",this._onMove),window.removeEventListener("touchend",this._onUp)}}createRenderRoot(){return this}render(){const e=this._positions();return X`
      <div
    ...
    `}_toggleSelectHass(e){const t=this.store.selectedTracks,s=new Set(t);s.has(e)?s.delete(e):s.add(e),this.store.setSelectedTracks(s)}_bulkRemoveHass(){const e=this.store.selectedTracks;this.store.removeQueueItems(new Set(e))}};xt.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([ue({attribute:!1})],xt.prototype,"store",void 0),xt=e([ce("hf-queue-tab")],xt);let yt=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups,t=e.filter(e=>!e.isIdle),s=e.filter(e=>e.isIdle);return X`
      <div class="header">
  ...
  `,e([ue({attribute:!1})],yt.prototype,"store",void 0),yt=e([ce("hf-output-tab")],yt);const _t=l`
  .hf-pip {
    display: inline-flex;
    align-items: flex-end;
    gap: 1.5px;
...
`;let wt=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups;return X`
      <div class="rail">
  ...
  `,e([ue({attribute:!1})],$t.prototype,"store",void 0),e([fe()],$t.prototype,"_draft",void 0),$t=e([ce("hf-group-sheet")],$t);const kt=[{key:"hasMA",name:"Music Assistant",why:"Browses libraries (Spotify, Apple Music, Tidal, …), drives playback, and surfaces now-playing metadata.",hint:"Install the Music Assistant add-on, then add the integration under Settings → Devices & Services.",link:"https://music-assistant.io"},{key:"hasQueueActions",name:"Music Assistant Queue Actions (mass_queue)",why:"Adds queue manipulation services (reorder, remove, clear) the card uses on the Queue tab. Registers services under the mass_queue domain.",hint:'Install via HACS — "Music Assistant Queue Actions" by droans — then add it under Settings → Devices & Services.',link:"https://github.com/droans/mass_queue"},{key:"hasWiim",name:"WiiM Audio (LinkPlay)",why:"Provides WiiM-native Linkplay grouping. The card uses this for all multi-room sync, never MA grouping.",hint:'Install via HACS — "WiiM Audio Integration for Home Assistant" by mjcumming — then add each device under Settings → Devices & Services.',link:"https://github.com/mjcumming/wiim"}];let St=class extends i{render(){if(!this.status)return X``;const e=kt.filter(e=>!this.status[e.key]),t=e.length;return X`
    ...
    `],e([ue({attribute:!1})],St.prototype,"status",void 0),St=e([ce("hf-setup-help")],St);let zt=class extends i{constructor(){super(...arguments),this._pickerInitTriggered=!1}setConfig(e){this._config={...e}}updated(){!this._pickerInitTriggered&&this.hass&&this._config&&!customElements.get("ha-entity-picker")&&(this._pickerInitTriggered=!0,this._loadEntityPicker())}async _loadEntityPicker(){try{const e=await(window.loadCardHelpers?.());if(!e?.createCardElement)return;const t=await e.createCardElement({type:"entities",entities:[]}),s=t?.constructor;await(s?.getConfigElement?.())}catch(e){console.warn("[homefront-music-card] failed to load ha-entity-picker:",e)}finally{this.requestUpdate()}}render(){return this._config?X`
  ...
  `,e([ue({attribute:!1})],zt.prototype,"hass",void 0),e([fe()],zt.prototype,"_config",void 0),zt=e([ce("hf-card-editor")],zt);let Mt=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){return this.store&&0!==this.store.toasts.length?X`
      ${this.store.toasts.map(e=>X`
        ...
        `)}
    `:X``}_iconFor(e){return"error"===e?De.x({size:14,sw:2.4}):"warning"===e?De.filter({size:14}):De.note({size:14})}};Mt.styles=l`
    :host {
      position: absolute;
      left: 0;
      right: 0;
  ...
  `,e([ue({attribute:!1})],Mt.prototype,"store",void 0),Mt=e([ce("hf-toast-bar")],Mt),window.customCards=window.customCards||[],window.customCards.push({type:"homefront-music-card",name:"Homefront Music Card",description:"Music Assistant + WiiM multi-room controller",preview:!1});const At=[{id:"player",label:"Player",icon:"play"},{id:"browser",label:"Browse",icon:"home"},{id:"search",label:"Search",icon:"search"},{id:"queue",label:"Queue",icon:"queue"},{id:"group",label:"Output",icon:"speaker"}];let It=class extends i{constructor(){super(),this._store=new Store,new StoreController(this,this._store)}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e,this._store.setConfig(e),"panel"===e.layout?this.setAttribute("data-layout","panel"):this.removeAttribute("data-layout"),e.accent_color?(this.style.setProperty("--hf-accent",e.accent_color),this.style.setProperty("--hf-accent-text",function(e){const t=e.trim().replace(/^#/,"");if(3!==t.length&&6!==t.length)return"#fff";const s=3===t.length?t.split("").map(e=>e+e).join(""):t,r=parseInt(s.slice(0,2),16),a=parseInt(s.slice(2,4),16),o=parseInt(s.slice(4,6),16);if([r,a,o].some(e=>Number.isNaN(e)))return"#fff";const n=(.2126*r+.7152*a+.0722*o)/255;return n>.55?"#111":"#fff"}(e.accent_color))):(this.style.removeProperty("--hf-accent"),this.style.removeProperty("--hf-accent-text"));const t=e.density??"regular";this.setAttribute("data-density",t);const s=e.theme??"dark";this.setAttribute("data-theme",s)}willUpdate(e){e.has("hass")&&this.hass&&(this._integrationStatus=function(e){const t=e.services??{},s=e.states??{},r=[],a=t.music_assistant??{},o=t.mass_queue??{},n=t.wiim??{},l=!!a.play_media;r.push({target:"MA",label:"service music_assistant.play_media",matched:l});const d=["get_queue_items","remove_queue_item","move_queue_item_up","play_queue_item","clear_queue_from_here"],c=d.find(e=>!!o[e]),h=!!c;r.push({target:"QueueActions",label:`mass_queue domain has any of ${d.join(", ")}`,matched:h});const p=Object.keys(o);p.length>0&&r.push({target:"QueueActions",label:`mass_queue domain services found: ${p.slice(0,6).join(", ")}${p.length>6?"…":""}`,matched:!0});const u=["play_preset","play_url","set_eq","get_queue"],f=u.find(e=>!!n[e]),m=!!f;r.push({target:"WiiM",label:`wiim domain has any of ${u.join(", ")}`,matched:m});const v=Object.keys(n);v.length>0&&r.push({target:"WiiM",label:`wiim domain services found: ${v.slice(0,6).join(", ")}${v.length>6?"…":""}`,matched:!0});const g=Object.values(s).some(e=>{if(!e.entity_id.startsWith("media_player."))return!1;const t=e.attributes.group_role;return"master"===t||"slave"===t||"solo"===t});r.push({target:"WiiM",label:"any media_player.* attribute group_role is master/slave/solo",matched:g});const b=m||g;return{hasMA:l,hasQueueActions:h,hasWiim:b,allPresent:l&&h&&b,diagnostics:r}}(this.hass),this._integrationStatus.allPresent&&this._store.setHass(this.hass))}getCardSize(){return 12}static getConfigElement(){return document.createElement("hf-card-editor")}static getStubConfig(){return{type:"custom:homefront-music-card"}}disconnectedCallback(){super.disconnectedCallback(),this._store.dispose()}render(){return this._integrationStatus&&!this._integrationStatus.allPresent?X`<hf-setup-help .status=${this._integrationStatus}></hf-setup-help>`:X`
    ...
    `}_renderActiveTab(){switch(this._store.tab){case"player":return X`<hf-player-tab .store=${this._store}></hf-player-tab>`;case"browser":return X`<hf-browse-tab .store=${this._store}></hf-browse-tab>`;case"search":return X`<hf-search-tab .store=${this._store}></hf-search-tab>`;case"queue":return X`<hf-queue-tab .store=${this._store}></hf-queue-tab>`;case"group":return X`<hf-output-tab .store=${this._store}></hf-output-tab>`}}_renderTabBar(){return X`
      <div class="tab-bar" role="tablist">
        ${At.map(e=>{const t=this._store.tab===e.id;return X`
            <button
              class="tab"
              role="tab"
              aria-selected=${t}
    ...
    `],e([ue({attribute:!1})],It.prototype,"hass",void 0),e([fe()],It.prototype,"_config",void 0),e([fe()],It.prototype,"_integrationStatus",void 0),It=e([ce("homefront-music-card")],It);export{It as HomefrontMusicCard};
