...
`;function Ie(e,t={}){return(s={})=>{const r=s.size??20,a=s.stroke??"currentColor",o=s.sw??t.sw??1.7;return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${e} /></svg>`}}function Ce(e){return(t={})=>{const s=t.size??20,r=t.fill??"currentColor";return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill=${r} stroke="none"><path d=${e} /></svg>`}}const Pe={play:Ce("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(e={})=>{const t=e.size??20,s=e.fill??"currentColor";return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill=${s} stroke="none">
  ...
  `,e([ue({attribute:!1})],De.prototype,"obj",void 0),e([ue()],De.prototype,"size",void 0),e([ue({type:Number})],De.prototype,"radius",void 0),e([ue({attribute:!1})],De.prototype,"glyph",void 0),e([ue()],De.prototype,"boxShadow",void 0),e([ue({attribute:"image-url"})],De.prototype,"imageUrl",void 0),De=e([ce("hf-album-art")],De);let Fe=class extends i{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.color="#fff",this.track="rgba(255,255,255,0.18)",this.trackHeight=4,this.thumb=14,this.ariaLabel="",this._onInput=e=>{const t=Number(e.target.value);this.value=t,this.dispatchEvent(new CustomEvent("hf-input",{detail:t,bubbles:!0,composed:!0}))}}render(){const e=(this.value-this.min)/(this.max-this.min)*100;return this.style.setProperty("--hf-pct",`${e}%`),this.style.setProperty("--hf-color",this.color),this.style.setProperty("--hf-track",this.track),this.style.setProperty("--hf-track-h",`${this.trackHeight}px`),this.style.setProperty("--hf-thumb",`${this.thumb}px`),X`<input
      type="range"
      min=${this.min}
      max=${this.max}
  ...
  `,e([ue({type:Number})],Fe.prototype,"value",void 0),e([ue({type:Number})],Fe.prototype,"min",void 0),e([ue({type:Number})],Fe.prototype,"max",void 0),e([ue()],Fe.prototype,"color",void 0),e([ue()],Fe.prototype,"track",void 0),e([ue({type:Number,attribute:"track-height"})],Fe.prototype,"trackHeight",void 0),e([ue({type:Number})],Fe.prototype,"thumb",void 0),e([ue({attribute:"aria-label"})],Fe.prototype,"ariaLabel",void 0),Fe=e([ce("hf-slider")],Fe);let We=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store,t=e.currentTrack,s=e.currentAlbum,r=e.activePlayer,a=e.activeGroup,o=e.groups.filter(e=>!e.isActive&&e.playing).length,n=s.imageUrl;return X`
      <div class="art-wrap">
        <hf-album-art
          .obj=${s}
          size="100%"
      ...
      <div class="transport">
        ...
        >
          ${r.playing?Pe.pause({size:22}):Pe.play({size:22})}
        </button>
        ...
        <button
          ...
          @click=${()=>e.cycleRepeat()}
        >
          ${"one"===r.repeat?Pe.rep1({size:18}):Pe.rep({size:18})}
        </button>
      </div>
      <div class="output">
        <button class="output-main" type="button" @click=${()=>e.setTab("group")}>
          ${Pe.speaker({size:16,stroke:we})}
  ...
  `,e([ue({attribute:!1})],We.prototype,"store",void 0),We=e([ce("hf-player-tab")],We);const Ge=[{id:"playlists",label:"Playlists"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"tracks",label:"Tracks"},{id:"radio",label:"Radio"}],Ve=[{id:"default",label:"Default (MA order)"},{id:"title_asc",label:"Title A → Z"},{id:"title_desc",label:"Title Z → A"}];let Ke=class extends i{constructor(){super(...arguments),this._kickedOffRoot=!1,this._sortMode="default",this._sortMenuOpen=!1,this._closeSortMenu=()=>{this._sortMenuOpen&&(this._sortMenuOpen=!1)}}willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}updated(){!this.store?.isHassMode||this._kickedOffRoot||0!==this.store.hassBrowseStack.length||this.store.hassBrowseLoading||(this._kickedOffRoot=!0,this.store.browseRoot())}render(){return this.store?this.store.isHassMode?this._renderHass():X`${this._renderCrumbs()} ${this._renderBody()}`:X``}_renderHass(){const e=this.store.hassBrowseStack,t=e[e.length-1];return X`
      ${this._renderHassCrumbs(e)}
      ${t&&(t.children?.length??0)>0?this._renderSortBar():""}
    ...
    `}_renderSortBar(){return X`
      <div class="sort-bar">
        <button
          class="sort-btn"
          @click=${e=>{e.stopPropagation(),this._sortMenuOpen=!this._sortMenuOpen}}
        >
          ${Pe.filter({size:12})} Sort: ${e=this._sortMode,Ve.find(t=>t.id===e)?.label.split(" ")[0]??"Default"}
        </button>
    ...
    `;var e}_chooseSort(e){this._sortMode=e,this._sortMenuOpen=!1}_applySort(e){if("default"===this._sortMode)return e;const t=[...e];return"title_asc"===this._sortMode?t.sort((e,t)=>e.title.localeCompare(t.title)):"title_desc"===this._sortMode&&t.sort((e,t)=>t.title.localeCompare(e.title)),t}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._closeSortMenu)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._closeSortMenu)}_renderHassCrumbs(e){return 0===e.length?X``:X`
      <div class="crumbs">
        ${e.map((t,s)=>{const r=s===e.length-1,a=0===s?"Sources":t.title;return X`
            ...
            ${s<e.length-1?X`<span aria-hidden="true">${Pe.chev({size:11})}</span>`:""}
          `})}
      </div>
    `}_renderHassNode(e){const t=e.children??[];if(0===t.length)return X`<div class="hass-empty">No items</div>`;const s=this._applySort(t);return X`<div class="body">${this._renderHassList(s)}</div>`}_renderHassList(e){return X`
      <div>
        ${e.map(e=>X`
            <button class="track-row" @click=${()=>this._onHassChildClick(e)}>
              ...
              ${e.can_expand?Pe.chev({size:14}):e.can_play?Pe.play({size:14}):""}
            </button>
          `)}
      </div>
    `}_onHassChildClick(e){e.can_expand?this.store.browseInto(e):e.can_play&&this.store.playBrowseNode(e,"replace")}_iconForClass(e){return"track"===e||"music"===e?Pe.note({size:16}):"album"===e?Pe.album({size:16}):"artist"===e?Pe.artist({size:16}):"playlist"===e?Pe.list({size:16}):"radio"===e?Pe.radio({size:16}):Pe.home({size:16})}_renderCrumbs(){const e=this.store.browser.crumbs;return X`
      <div class="crumbs">
        ...
        ${Be.radioStations.map(e=>X`
            <button class="radio-row">
              <hf-album-art
                ...
                size="44"
                radius="10"
                .glyph=${Pe.radio({size:18,stroke:"#fff"})}
              ></hf-album-art>
              <div style="flex:1; min-width:0">
        ...
        <div class="detail-header">
          ...
          <div class="detail-meta">
            ...
            <div class="detail-actions">
              <button class="pill-btn primary">${Pe.play({size:13})} Play</button>
              <button class="pill-btn">${Pe.plus({size:13})} Queue</button>
            </div>
          </div>
        </div>
        <div class="body">
  ...
  `,e([ue({attribute:!1})],Ke.prototype,"store",void 0),e([me()],Ke.prototype,"_sortMode",void 0),e([me()],Ke.prototype,"_sortMenuOpen",void 0),Ke=e([ce("hf-browse-tab")],Ke);const Ye=[{id:"all",label:"All"},{id:"tracks",label:"Tracks"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"playlists",label:"Playlists"}],Je=["khruangbin","jazz","deep focus","ambient","tycho","discover weekly"];let Xe=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store,t=e.search.query.trim().toLowerCase(),s=e.search.filter,r=t?this._matchesFor(t):null;return X`
      <div class="top">
  ...
  `,e([ue({attribute:!1})],Xe.prototype,"store",void 0),Xe=e([ce("hf-search-tab")],Xe);let Ze=class extends i{constructor(){super(...arguments),this.rowHeight=56,this.actionBg="#e0413a",this._dx=0,this._dragging=!1,this._startX=null,this._startDx=0,this._onDown=e=>{const t="touches"in e?e.touches[0].clientX:e.clientX;this._startX=t,this._startDx=this._dx,this._dragging=!0},this._onMove=e=>{if(null===this._startX)return;const t="touches"in e?e.touches[0].clientX:e.clientX;let s=this._startDx+(t-this._startX);s>0&&(s=0),s<-110&&(s=-110),this._dx=s},this._onUp=()=>{this._startX=null,this._dragging=!1,this._dx=this._dx<-64?-92:0},this._fireDelete=()=>{this.dispatchEvent(new CustomEvent("hf-delete",{bubbles:!0,composed:!0})),this._dx=0}}render(){return X`
      <div
        class="action"
  ...
  `,e([ue({type:Number})],Ze.prototype,"rowHeight",void 0),e([ue()],Ze.prototype,"actionBg",void 0),e([ue({attribute:!1})],Ze.prototype,"icon",void 0),e([me()],Ze.prototype,"_dx",void 0),e([me()],Ze.prototype,"_dragging",void 0),Ze=e([ce("hf-swipe-row")],Ze);let et=class extends i{constructor(){super(...arguments),this.items=[],this.rowHeight=56,this.renderRow=()=>X``,this._dragIdx=null,this._hoverIdx=null,this._startY=0,this._onMove=e=>{if(null===this._dragIdx)return;const t=("touches"in e?e.touches[0].clientY:e.clientY)-this._startY,s=Math.round(this._dragIdx+t/this.rowHeight);this._hoverIdx=Math.max(0,Math.min(this.items.length-1,s))},this._onUp=()=>{null!==this._dragIdx&&null!==this._hoverIdx&&this._hoverIdx!==this._dragIdx&&this.dispatchEvent(new CustomEvent("hf-reorder",{detail:{from:this._dragIdx,to:this._hoverIdx},bubbles:!0,composed:!0})),this._dragIdx=null,this._hoverIdx=null,window.removeEventListener("mousemove",this._onMove),window.removeEventListener("mouseup",this._onUp),window.removeEventListener("touchmove",this._onMove),window.removeEventListener("touchend",this._onUp)}}createRenderRoot(){return this}render(){const e=this._positions();return X`
      <div
    ...
    `}_toggleSelectHass(e){const t=this.store.selectedTracks,s=new Set(t);s.has(e)?s.delete(e):s.add(e),this.store.setSelectedTracks(s)}_bulkRemoveHass(){const e=this.store.selectedTracks;this.store.removeQueueItems(new Set(e))}};tt.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([ue({attribute:!1})],tt.prototype,"store",void 0),tt=e([ce("hf-queue-tab")],tt);let it=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups,t=e.filter(e=>!e.isIdle),s=e.filter(e=>e.isIdle);return X`
      <div class="header">
    ...
    `}_renderGroupCard(e){const t=e.player?Be.trackById(e.player.queue[e.player.currentIdx]??""):void 0,s=t?Be.albumById(t.albumId):void 0,r=e.player?.groupVolume??e.lead.volume;return X`
      <div class="group-card" data-active=${e.isActive}>
        <div class="group-head">
          ${s?X`<hf-album-art .obj=${s} size="46" radius="9"></hf-album-art>`:X`<div class="group-art">${Pe.speaker({size:18})}</div>`}
          ...
          <div class="group-actions">
            ...
            >
              ${e.playing?Pe.pause({size:14}):Pe.play({size:14})}
            </button>
          </div>
        </div>
    ...
    `}_renderIdleRow(e){const t=e.lead;return X`
      <div class="idle-row">
        <div class="idle-icon">${Pe.speaker({size:14})}</div>
        <div class="idle-info">
  ...
  `,e([ue({attribute:!1})],it.prototype,"store",void 0),it=e([ce("hf-output-tab")],it);const st=l`
  .hf-pip {
    display: inline-flex;
    align-items: flex-end;
    gap: 1.5px;
...
`;let rt=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups;return X`
      <div class="rail">
  ...
  `}(t):Pe.speaker({size:11,stroke:"currentColor"})}
  ...
  `,e([ue({attribute:!1})],at.prototype,"store",void 0),e([me()],at.prototype,"_draft",void 0),at=e([ce("hf-group-sheet")],at);const ot=[{key:"hasMA",name:"Music Assistant",why:"Browses libraries (Spotify, Apple Music, Tidal, …), drives playback, and surfaces now-playing metadata.",hint:"Install the Music Assistant add-on, then add the integration under Settings → Devices & Services.",link:"https://music-assistant.io"},{key:"hasQueueActions",name:"Music Assistant Queue Actions (mass_queue)",why:"Adds queue manipulation services (reorder, remove, clear) the card uses on the Queue tab. Registers services under the mass_queue domain.",hint:'Install via HACS — "Music Assistant Queue Actions" by droans — then add it under Settings → Devices & Services.',link:"https://github.com/droans/mass_queue"},{key:"hasWiim",name:"WiiM Audio (LinkPlay)",why:"Provides WiiM-native Linkplay grouping. The card uses this for all multi-room sync, never MA grouping.",hint:'Install via HACS — "WiiM Audio Integration for Home Assistant" by mjcumming — then add each device under Settings → Devices & Services.',link:"https://github.com/mjcumming/wiim"}];let nt=class extends i{render(){if(!this.status)return X``;const e=ot.filter(e=>!this.status[e.key]),t=e.length;return X`
    ...
    `}_renderRow(e){const t=this.status[e.key];return X`
      <div class="row" data-state=${t?"ok":"missing"}>
        <div class="row-status">
          ${t?Pe.check({size:14,sw:2.4}):Pe.plus({size:14,sw:2.4})}
        </div>
        <div class="row-body">
          <div class="row-name">${e.name}</div>
    ...
    `}_renderTitle(){const e=this._config?.zones?.length??0,t=this._store.groups.filter(e=>e.playing).length,s=e>0?` · ${e} zone${1===e?"":"s"}`:" · mock";return X`
      <div class="title-row">
        <span class="title-icon">${Pe.note({size:14})}</span>
    ...
    `}_renderActiveTab(){switch(this._store.tab){case"player":return X`<hf-player-tab .store=${this._store}></hf-player-tab>`;case"browser":return X`<hf-browse-tab .store=${this._store}></hf-browse-tab>`;case"search":return X`<hf-search-tab .store=${this._store}></hf-search-tab>`;case"queue":return X`<hf-queue-tab .store=${this._store}></hf-queue-tab>`;case"group":return X`<hf-output-tab .store=${this._store}></hf-output-tab>`}}_renderTabBar(){return X`
      <div class="tab-bar" role="tablist">
        ${lt.map(e=>{const t=this._store.tab===e.id;return X`
            <button
              class="tab"
              role="tab"
              aria-selected=${t}
    ...
    `],e([ue({attribute:!1})],dt.prototype,"hass",void 0),e([me()],dt.prototype,"_config",void 0),e([me()],dt.prototype,"_integrationStatus",void 0),dt=e([ce("homefront-music-card")],dt);export{dt as HomefrontMusicCard};
