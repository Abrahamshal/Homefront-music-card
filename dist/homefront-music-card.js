...
`;function Mt(t,e={}){return(r={})=>{const s=r.size??20,a=r.stroke??"currentColor",o=r.sw??e.sw??1.7;return J`<svg width=${s} height=${s} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${t} /></svg>`}}function Ct(t){return(e={})=>{const r=e.size??20,s=e.fill??"currentColor";return J`<svg width=${r} height=${r} viewBox="0 0 24 24" fill=${s} stroke="none"><path d=${t} /></svg>`}}const Pt={play:Ct("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(t={})=>{const e=t.size??20,r=t.fill??"currentColor";return J`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${r} stroke="none">
  ...
  `,t([ut({attribute:!1})],Gt.prototype,"store",void 0),Gt=t([ct("hf-browse-tab")],Gt);const Qt=[{id:"all",label:"All"},{id:"tracks",label:"Tracks"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"playlists",label:"Playlists"}],Wt=["khruangbin","jazz","deep focus","ambient","tycho","discover weekly"];let Vt=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return J``;const t=this.store,e=t.search.query.trim().toLowerCase(),r=t.search.filter,s=e?this._matchesFor(e):null;return J`
      <div class="top">
  ...
  `,t([ut({type:Number})],Ft.prototype,"rowHeight",void 0),t([ut()],Ft.prototype,"actionBg",void 0),t([ut({attribute:!1})],Ft.prototype,"icon",void 0),t([ft()],Ft.prototype,"_dx",void 0),t([ft()],Ft.prototype,"_dragging",void 0),Ft=t([ct("hf-swipe-row")],Ft);let Yt=class extends i{constructor(){super(...arguments),this.items=[],this.rowHeight=56,this.renderRow=()=>J``,this._dragIdx=null,this._hoverIdx=null,this._startY=0,this._onMove=t=>{if(null===this._dragIdx)return;const e=("touches"in t?t.touches[0].clientY:t.clientY)-this._startY,r=Math.round(this._dragIdx+e/this.rowHeight);this._hoverIdx=Math.max(0,Math.min(this.items.length-1,r))},this._onUp=()=>{null!==this._dragIdx&&null!==this._hoverIdx&&this._hoverIdx!==this._dragIdx&&this.dispatchEvent(new CustomEvent("hf-reorder",{detail:{from:this._dragIdx,to:this._hoverIdx},bubbles:!0,composed:!0})),this._dragIdx=null,this._hoverIdx=null,window.removeEventListener("mousemove",this._onMove),window.removeEventListener("mouseup",this._onUp),window.removeEventListener("touchmove",this._onMove),window.removeEventListener("touchend",this._onUp)}}createRenderRoot(){return this}render(){const t=this._positions();return J`
      <div
