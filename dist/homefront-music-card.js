...
`;function Ie(e,t={}){return(s={})=>{const r=s.size??20,a=s.stroke??"currentColor",o=s.sw??t.sw??1.7;return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${e} /></svg>`}}function Ce(e){return(t={})=>{const s=t.size??20,r=t.fill??"currentColor";return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill=${r} stroke="none"><path d=${e} /></svg>`}}const Ee={play:Ce("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(e={})=>{const t=e.size??20,s=e.fill??"currentColor";return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill=${s} stroke="none">
  ...
  `,e([ue({attribute:!1})],Fe.prototype,"store",void 0),Fe=e([ce("hf-player-tab")],Fe);const We=[{id:"playlists",label:"Playlists"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"tracks",label:"Tracks"},{id:"radio",label:"Radio"}];let Ge=class extends i{constructor(){super(...arguments),this._kickedOffRoot=!1}willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}updated(){!this.store?.isHassMode||this._kickedOffRoot||0!==this.store.hassBrowseStack.length||this.store.hassBrowseLoading||(this._kickedOffRoot=!0,this.store.browseRoot())}render(){return this.store?this.store.isHassMode?this._renderHass():X`${this._renderCrumbs()} ${this._renderBody()}`:X``}_renderHass(){const e=this.store.hassBrowseStack,t=e[e.length-1];return X`
    ...
    `}_renderHassNode(e){const t=e.children??[];if(0===t.length)return X`<div class="hass-empty">No items</div>`;const s=t.every(e=>"playlist"===e.media_class)&&t.some(e=>e.thumbnail);return X`
      <div class="body">
  ...
  `,e([ue({attribute:!1})],Ge.prototype,"store",void 0),Ge=e([ce("hf-browse-tab")],Ge);const Ve=[{id:"all",label:"All"},{id:"tracks",label:"Tracks"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"playlists",label:"Playlists"}],Ke=["khruangbin","jazz","deep focus","ambient","tycho","discover weekly"];let Ye=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store,t=e.search.query.trim().toLowerCase(),s=e.search.filter,r=t?this._matchesFor(t):null;return X`
      <div class="top">
  ...
  `,e([ue({attribute:!1})],Ye.prototype,"store",void 0),Ye=e([ce("hf-search-tab")],Ye);let Je=class extends i{constructor(){super(...arguments),this.rowHeight=56,this.actionBg="#e0413a",this._dx=0,this._dragging=!1,this._startX=null,this._startDx=0,this._onDown=e=>{const t="touches"in e?e.touches[0].clientX:e.clientX;this._startX=t,this._startDx=this._dx,this._dragging=!0},this._onMove=e=>{if(null===this._startX)return;const t="touches"in e?e.touches[0].clientX:e.clientX;let s=this._startDx+(t-this._startX);s>0&&(s=0),s<-110&&(s=-110),this._dx=s},this._onUp=()=>{this._startX=null,this._dragging=!1,this._dx=this._dx<-64?-92:0},this._fireDelete=()=>{this.dispatchEvent(new CustomEvent("hf-delete",{bubbles:!0,composed:!0})),this._dx=0}}render(){return X`
      <div
        class="action"
  ...
  `,e([ue({type:Number})],Je.prototype,"rowHeight",void 0),e([ue()],Je.prototype,"actionBg",void 0),e([ue({attribute:!1})],Je.prototype,"icon",void 0),e([me()],Je.prototype,"_dx",void 0),e([me()],Je.prototype,"_dragging",void 0),Je=e([ce("hf-swipe-row")],Je);let Xe=class extends i{constructor(){super(...arguments),this.items=[],this.rowHeight=56,this.renderRow=()=>X``,this._dragIdx=null,this._hoverIdx=null,this._startY=0,this._onMove=e=>{if(null===this._dragIdx)return;const t=("touches"in e?e.touches[0].clientY:e.clientY)-this._startY,s=Math.round(this._dragIdx+t/this.rowHeight);this._hoverIdx=Math.max(0,Math.min(this.items.length-1,s))},this._onUp=()=>{null!==this._dragIdx&&null!==this._hoverIdx&&this._hoverIdx!==this._dragIdx&&this.dispatchEvent(new CustomEvent("hf-reorder",{detail:{from:this._dragIdx,to:this._hoverIdx},bubbles:!0,composed:!0})),this._dragIdx=null,this._hoverIdx=null,window.removeEventListener("mousemove",this._onMove),window.removeEventListener("mouseup",this._onUp),window.removeEventListener("touchmove",this._onMove),window.removeEventListener("touchend",this._onUp)}}createRenderRoot(){return this}render(){const e=this._positions();return X`
      <div
    ...
    `}_toggleSelectHass(e){const t=this.store.selectedTracks,s=new Set(t);s.has(e)?s.delete(e):s.add(e),this.store.setSelectedTracks(s)}_bulkRemoveHass(){const e=this.store.selectedTracks;this.store.removeQueueItems(new Set(e))}};Ze.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([ue({attribute:!1})],Ze.prototype,"store",void 0),Ze=e([ce("hf-queue-tab")],Ze);let et=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups,t=e.filter(e=>!e.isIdle),s=e.filter(e=>e.isIdle);return X`
      <div class="header">
  ...
  `,e([ue({attribute:!1})],et.prototype,"store",void 0),et=e([ce("hf-output-tab")],et);const tt=l`
  .hf-pip {
    display: inline-flex;
    align-items: flex-end;
    gap: 1.5px;
...
`;let it=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups;return X`
      <div class="rail">
  ...
  `,e([ue({attribute:!1})],st.prototype,"store",void 0),e([me()],st.prototype,"_draft",void 0),st=e([ce("hf-group-sheet")],st);const rt=[{key:"hasMA",name:"Music Assistant",why:"Browses libraries (Spotify, Apple Music, Tidal, …), drives playback, and surfaces now-playing metadata.",hint:"Install the Music Assistant add-on, then add the integration under Settings → Devices & Services.",link:"https://music-assistant.io"},{key:"hasQueueActions",name:"Music Assistant Queue Actions (mass_queue)",why:"Adds queue manipulation services (reorder, remove, clear) the card uses on the Queue tab. Registers services under the mass_queue domain.",hint:'Install via HACS — "Music Assistant Queue Actions" by droans — then add it under Settings → Devices & Services.',link:"https://github.com/droans/mass_queue"},{key:"hasWiim",name:"WiiM Audio (LinkPlay)",why:"Provides WiiM-native Linkplay grouping. The card uses this for all multi-room sync, never MA grouping.",hint:'Install via HACS — "WiiM Audio Integration for Home Assistant" by mjcumming — then add each device under Settings → Devices & Services.',link:"https://github.com/mjcumming/wiim"}];let at=class extends i{render(){if(!this.status)return X``;const e=rt.filter(e=>!this.status[e.key]),t=e.length;return X`
    ...
    `}_renderActiveTab(){switch(this._store.tab){case"player":return X`<hf-player-tab .store=${this._store}></hf-player-tab>`;case"browser":return X`<hf-browse-tab .store=${this._store}></hf-browse-tab>`;case"search":return X`<hf-search-tab .store=${this._store}></hf-search-tab>`;case"queue":return X`<hf-queue-tab .store=${this._store}></hf-queue-tab>`;case"group":return X`<hf-output-tab .store=${this._store}></hf-output-tab>`}}_renderTabBar(){return X`
      <div class="tab-bar" role="tablist">
        ${ot.map(e=>{const t=this._store.tab===e.id;return X`
            <button
              class="tab"
              role="tab"
              aria-selected=${t}
    ...
    `],e([ue({attribute:!1})],nt.prototype,"hass",void 0),e([me()],nt.prototype,"_config",void 0),e([me()],nt.prototype,"_integrationStatus",void 0),nt=e([ce("homefront-music-card")],nt);export{nt as HomefrontMusicCard};
