...
`;function je(e,t={}){return(s={})=>{const r=s.size??20,a=s.stroke??"currentColor",o=s.sw??t.sw??1.7;return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${e} /></svg>`}}function Ne(e){return(t={})=>{const s=t.size??20,r=t.fill??"currentColor";return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill=${r} stroke="none"><path d=${e} /></svg>`}}const De={play:Ne("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(e={})=>{const t=e.size??20,s=e.fill??"currentColor";return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill=${s} stroke="none">
      <rect x="6" y="5" width="4.2" height="14" rx="1.2" />
      <rect x="13.8" y="5" width="4.2" height="14" rx="1.2" />
    </svg>`},prev:Ne("M6 5h2v14H6V5zm14 .9v12.2a1 1 0 0 1-1.55.83L9 12.83a1 1 0 0 1 0-1.66l9.45-6.1A1 1 0 0 1 20 5.9z"),next:Ne("M18 5h-2v14h2V5zM4 5.9v12.2a1 1 0 0 0 1.55.83L15 12.83a1 1 0 0 0 0-1.66L5.55 5.07A1 1 0 0 0 4 5.9z"),shuffle:je("M16 4h4v4 M20 4l-7 7 M4 4l16 16 M16 20h4v-4 M4 20l5-5"),rep:je("M4 9V8a3 3 0 0 1 3-3h11l-3-3 M20 15v1a3 3 0 0 1-3 3H6l3 3"),rep1:(e={})=>{const t=e.size??20,s=e.stroke??"currentColor",r=e.sw??1.7;return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill="none" stroke=${s} stroke-width=${r} stroke-linecap="round" stroke-linejoin="round">
    ...
    </svg>`},queue:je("M4 7h11 M4 12h11 M4 17h7 M16 14v6 l3-2"),search:je("M11 4a7 7 0 1 0 4.6 12.3L20 20 M11 4a7 7 0 0 1 7 7"),home:je("M4 11l8-7 8 7v8a2 2 0 0 1-2 2h-3v-6h-6v6H6a2 2 0 0 1-2-2v-8z"),speaker:je("M5 9h3l4-4v14l-4-4H5z M16 8a5 5 0 0 1 0 8 M19 5a9 9 0 0 1 0 14"),group:je("M7 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M17 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6z M3 20c0-3 2.7-5 6-5s4 1 4 1 M14 21c0-2.5 1.5-4 4-4s4 1.5 4 4"),dot3:(e={})=>{const t=e.size??20,s=e.fill??"currentColor";return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill=${s} stroke="none">
      <circle cx="5" cy="12" r="1.6" />
      <circle cx="12" cy="12" r="1.6" />
      <circle cx="19" cy="12" r="1.6" />
    </svg>`},x:je("M6 6l12 12 M18 6L6 18"),chev:je("M9 6l6 6-6 6"),chevL:je("M15 6l-6 6 6 6"),chevD:je("M6 9l6 6 6-6"),plus:je("M12 5v14 M5 12h14"),check:je("M5 12l4 4 10-10"),drag:(e={})=>{const t=e.size??20,s=e.fill??"currentColor";return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill=${s} stroke="none">
      <circle cx="9" cy="6" r="1.5" /><circle cx="15" cy="6" r="1.5" />
      <circle cx="9" cy="12" r="1.5" /><circle cx="15" cy="12" r="1.5" />
      <circle cx="9" cy="18" r="1.5" /><circle cx="15" cy="18" r="1.5" />
    </svg>`},trash:je("M5 7h14 M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2 M7 7l1 13a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2l1-13"),top:je("M12 19V7 M6 13l6-6 6 6 M5 4h14"),playNext:je("M5 5l10 7-10 7V5z M19 6v12",{sw:2}),radio:je("M4 12a8 8 0 0 1 14-5.5 M6 16a4 4 0 0 1 5-5 M3 20l14-14"),list:je("M4 6h16 M4 12h16 M4 18h16"),album:(e={})=>{const t=e.size??20,s=e.stroke??"currentColor",r=e.sw??1.6;return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill="none" stroke=${s} stroke-width=${r} stroke-linecap="round" stroke-linejoin="round">
  ...
  `,e([ue({attribute:!1})],at.prototype,"obj",void 0),e([ue()],at.prototype,"size",void 0),e([ue({type:Number})],at.prototype,"radius",void 0),e([ue({attribute:!1})],at.prototype,"glyph",void 0),e([ue()],at.prototype,"boxShadow",void 0),e([ue({attribute:"image-url"})],at.prototype,"imageUrl",void 0),at=e([ce("hf-album-art")],at);let ot=class extends i{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.color="#fff",this.track="rgba(255,255,255,0.18)",this.trackHeight=4,this.thumb=14,this.ariaLabel="",this._onInput=e=>{const t=Number(e.target.value);this.value=t,this.dispatchEvent(new CustomEvent("hf-input",{detail:t,bubbles:!0,composed:!0}))}}render(){const e=(this.value-this.min)/(this.max-this.min)*100;return this.style.setProperty("--hf-pct",`${e}%`),this.style.setProperty("--hf-color",this.color),this.style.setProperty("--hf-track",this.track),this.style.setProperty("--hf-track-h",`${this.trackHeight}px`),this.style.setProperty("--hf-thumb",`${this.thumb}px`),X`<input
      type="range"
      min=${this.min}
      max=${this.max}
  ...
  `,e([ue({type:Number})],ot.prototype,"value",void 0),e([ue({type:Number})],ot.prototype,"min",void 0),e([ue({type:Number})],ot.prototype,"max",void 0),e([ue()],ot.prototype,"color",void 0),e([ue()],ot.prototype,"track",void 0),e([ue({type:Number,attribute:"track-height"})],ot.prototype,"trackHeight",void 0),e([ue({type:Number})],ot.prototype,"thumb",void 0),e([ue({attribute:"aria-label"})],ot.prototype,"ariaLabel",void 0),ot=e([ce("hf-slider")],ot);let nt=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store,t=e.currentTrack,s=e.currentAlbum,r=e.activePlayer,a=e.activeGroup,o=e.groups.filter(e=>!e.isActive&&e.playing).length,n=s.imageUrl;return X`
      <div class="art-wrap">
        <hf-album-art
          .obj=${s}
          size="100%"
  ...
  `,e([ue({attribute:!1})],nt.prototype,"store",void 0),nt=e([ce("hf-player-tab")],nt);const lt=[{id:"playlists",label:"Playlists"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"tracks",label:"Tracks"},{id:"radio",label:"Radio"}],dt=[{id:"default",label:"Default (MA order)"},{id:"title_asc",label:"Title A → Z"},{id:"title_desc",label:"Title Z → A"}];function ct(e){if("string"==typeof e)return"[object Object]"===e?"":e;if("number"==typeof e)return String(e);if(Array.isArray(e)&&e.length>0)return ct(e[0]);if(e&&"object"==typeof e){const t=e;return ct(t.name)||ct(t.title)||ct(t.path)||ct(t.url)||""}return""}let ht=class extends i{constructor(){super(...arguments),this._kickedOffRoot=!1,this._sortMode="default",this._sortMenuOpen=!1,this._filterQuery="",this._lastStackDepth=0,this._closeSortMenu=()=>{this._sortMenuOpen&&(this._sortMenuOpen=!1)}}willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}updated(){!this.store?.isHassMode||this._kickedOffRoot||0!==this.store.hassBrowseStack.length||this.store.hassBrowseLoading||(this._kickedOffRoot=!0,this.store.browseRoot());const e=this.store?.hassBrowseStack?.length??0;e!==this._lastStackDepth&&(this._lastStackDepth=e,""!==this._filterQuery&&(this._filterQuery=""))}render(){return this.store?this.store.isHassMode?this._renderHass():X`${this._renderCrumbs()} ${this._renderBody()}`:X``}_renderHass(){const e=this.store.hassBrowseStack,t=e[e.length-1],s=!!t&&(t.children?.length??0)>5;return X`
    ...
    `}_renderControlsBar(){return X`
      <div class="controls-bar">
        ...
        >
          ${De.filter({size:12})} ${e=this._sortMode,dt.find(t=>t.id===e)?.label.split(" ")[0]??"Default"}
        </button>
    ...
    `;var e}_chooseSort(e){this._sortMode=e,this._sortMenuOpen=!1}_applySort(e){if("default"===this._sortMode)return e;const t=[...e];return"title_asc"===this._sortMode?t.sort((e,t)=>e.title.localeCompare(t.title)):"title_desc"===this._sortMode&&t.sort((e,t)=>t.title.localeCompare(e.title)),t}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._closeSortMenu)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._closeSortMenu)}_renderHassCrumbs(e){return 0===e.length?X``:X`
      <div class="crumbs">
        ${e.map((t,s)=>{const r=s===e.length-1,a=0===s?"Sources":ct(t.title)||"Item";return X`
            <button
              class="crumb-btn"
              data-current=${r}
    ...
    `}_renderHassNode(e){const t=e.children??[];if(0===t.length)return X`<div class="hass-empty">No items</div>`;const s=this._applyFilter(t),r=this._applySort(s);return 0===r.length?X`
      ...
      `:X`<div class="body">${this._renderHassList(r)}</div>`}_applyFilter(e){const t=this._filterQuery.trim().toLowerCase();return t?e.filter(e=>ct(e.title).toLowerCase().includes(t)):e}_renderHassList(e){return X`
      <div>
        ${e.map(e=>{const t=ct(e.title)||"(untitled)",s=ct(e.media_class),r=ct(e.thumbnail);return X`
    ...
    `}_renderBody(){const{providerId:e,accountId:t,sub:s,detailId:r}=this.store.browser;if(!e)return this._renderProviders();const a=Ye.providerById(e);return a?t?r?this._renderDetail(r):this._renderTypeView(s):this._renderAccounts(a):X``}_renderProviders(){return X`
      <div class="body">
        <div class="section-label">Connected sources</div>
        <div class="stack">
          ${Ye.providers.map(e=>this._renderProviderTile(e))}
        </div>
      </div>
    ...
    `}_renderTypeBody(e){return"playlists"===e?X`
      ...
      `:"artists"===e?X`
        <div>
          ${Ye.artistList.slice(0,12).map((e,t)=>X`
      ...
      `:"tracks"===e?X`
        <div>
          ${Ye.tracks.slice(0,12).map((e,t)=>this._renderTrackRow(e,t+1))}
        </div>
      `:X`
      <div class="stack">
        ${Ye.radioStations.map(e=>X`
    ...
    `}_renderTrackRow(e,t){const s=Ye.albumById(e.albumId);return X`
    ...
    `}_renderDetail(e){const t=Ye.playlists.find(t=>t.id===e),s=Ye.albums.find(t=>t.id===e),r=t??s;if(!r)return X``;const a=!!t;return X`
      <div>
        ...
        <div class="body">
          ${Ye.tracks.slice(0,10).map((e,t)=>this._renderTrackRow(e,t+1))}
        </div>
      </div>
    `}};ht.styles=l`
    :host {
  ...
  `,e([ue({attribute:!1})],ht.prototype,"store",void 0),e([fe()],ht.prototype,"_sortMode",void 0),e([fe()],ht.prototype,"_sortMenuOpen",void 0),e([fe()],ht.prototype,"_filterQuery",void 0),ht=e([ce("hf-browse-tab")],ht);const pt=[{id:"all",label:"All"},{id:"tracks",label:"Tracks"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"playlists",label:"Playlists"}],ut=["khruangbin","jazz","deep focus","ambient","tycho","discover weekly"],ft=new Set;let mt=class extends i{constructor(){super(...arguments),this._searchTimer=null,this._lastFiredQuery=""}willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}disconnectedCallback(){super.disconnectedCallback(),null!==this._searchTimer&&(window.clearTimeout(this._searchTimer),this._searchTimer=null)}_scheduleHassSearch(e,t){null!==this._searchTimer&&window.clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{if(e===this._lastFiredQuery)return;this._lastFiredQuery=e;const s=function(e){switch(e){case"tracks":return["track"];case"albums":return["album"];case"artists":return["artist"];case"playlists":return["playlist"];default:return[]}}(t);this.store.searchMa(e,s,25)},350)}render(){if(!this.store)return X``;if(this.store.isHassMode)return this._renderHass();const e=this.store,t=e.search.query.trim().toLowerCase(),s=e.search.filter,r=t?this._matchesFor(t):null;return X`
    ...
    `}_matchesFor(e){const t=t=>t.toLowerCase().includes(e);return{tracks:Ye.tracks.filter(e=>t(e.name)||t(e.artist)),albums:Ye.albums.filter(e=>t(e.name)||t(e.artist)),artists:Ye.artistList.filter(t),playlists:Ye.playlists.filter(e=>t(e.name))}}_renderResults(e,t){return X`
      <div class="body">
        ${Ye.providers.map(s=>this._renderProviderSection(s,e,t))}
      </div>
      ...
      <div class="section">
        ...
        ${r.length>0?X`
              <div style="margin-bottom:6px">
                ...
                ${r.map(e=>{const t=Ye.albumById(e.albumId);return X`
                    <div class="track-row">
    ...
    `}_renderSuggestions(){return X`
      <div class="suggestions">
        ...
        ${Ye.tracks.slice(0,4).map(e=>{const t=Ye.albumById(e.albumId);return X`
            <div class="track-row">
              <hf-album-art .obj=${t} size="36" radius="6"></hf-album-art>
              <div class="row-meta">
                <div class="row-name">${e.name}</div>
    ...
    `}_renderHassResultRow(e){const t=e,s=vt(t.title)??vt(t.name)??"(untitled)",r=[],a=vt(t.artist)??vt(t.artists);a&&r.push(a);const o=vt(t.album);o&&o!==s&&r.push(o);const n=vt(t.provider)??vt(t.provider_mappings);n&&r.push(n);const l=r.join(" · "),d=gt(t),c="number"==typeof t.duration?t.duration:"number"==typeof t.duration_seconds?t.duration_seconds:void 0;return ft.has(t.uri??s)||(ft.add(t.uri??s),ft.size<6&&console.debug("[homefront-music-card] search row extract:",{title:s,artistStr:a,albumStr:o,image:d,rawArtist:t.artist,rawArtists:t.artists,rawAlbum:t.album,rawMetadata:t.metadata})),X`
    ...
    `}};function vt(e){if("string"==typeof e){const t=e.trim();if(!t)return;if("[object Object]"===t)return;return t}if(Array.isArray(e)&&e.length>0)return vt(e[0]);if(e&&"object"==typeof e){const t=e;return vt(t.name)??vt(t.title)??vt(t.display_name)??void 0}}function gt(e){const t=e=>{if("string"==typeof e&&e&&("undefined"==typeof location||"https:"!==location.protocol||!e.startsWith("http:")))return e},s=t(e.image_url)??t(e.thumbnail)??t(e.image);if(s)return s;const r=e.metadata,a=r?.images?.[0];if(a){const e=t(a.path)??t(a.url);if(e)return e}for(const t of["album","artist","artists"]){const s=e[t];if(Array.isArray(s)&&s.length>0){const e=gt(s[0]);if(e)return e}else if(s&&"object"==typeof s){const e=gt(s);if(e)return e}}}mt.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([ue({attribute:!1})],mt.prototype,"store",void 0),mt=e([ce("hf-search-tab")],mt);let bt=class extends i{constructor(){super(...arguments),this.rowHeight=56,this.actionBg="#e0413a",this._dx=0,this._dragging=!1,this._startX=null,this._startDx=0,this._onDown=e=>{const t="touches"in e?e.touches[0].clientX:e.clientX;this._startX=t,this._startDx=this._dx,this._dragging=!0},this._onMove=e=>{if(null===this._startX)return;const t="touches"in e?e.touches[0].clientX:e.clientX;let s=this._startDx+(t-this._startX);s>0&&(s=0),s<-110&&(s=-110),this._dx=s},this._onUp=()=>{this._startX=null,this._dragging=!1,this._dx=this._dx<-64?-92:0},this._fireDelete=()=>{this.dispatchEvent(new CustomEvent("hf-delete",{bubbles:!0,composed:!0})),this._dx=0}}render(){return X`
      <div
        class="action"
  ...
  `,e([ue({type:Number})],bt.prototype,"rowHeight",void 0),e([ue()],bt.prototype,"actionBg",void 0),e([ue({attribute:!1})],bt.prototype,"icon",void 0),e([fe()],bt.prototype,"_dx",void 0),e([fe()],bt.prototype,"_dragging",void 0),bt=e([ce("hf-swipe-row")],bt);let xt=class extends i{constructor(){super(...arguments),this.items=[],this.rowHeight=56,this.renderRow=()=>X``,this._dragIdx=null,this._hoverIdx=null,this._startY=0,this._onMove=e=>{if(null===this._dragIdx)return;const t=("touches"in e?e.touches[0].clientY:e.clientY)-this._startY,s=Math.round(this._dragIdx+t/this.rowHeight);this._hoverIdx=Math.max(0,Math.min(this.items.length-1,s))},this._onUp=()=>{null!==this._dragIdx&&null!==this._hoverIdx&&this._hoverIdx!==this._dragIdx&&this.dispatchEvent(new CustomEvent("hf-reorder",{detail:{from:this._dragIdx,to:this._hoverIdx},bubbles:!0,composed:!0})),this._dragIdx=null,this._hoverIdx=null,window.removeEventListener("mousemove",this._onMove),window.removeEventListener("mouseup",this._onUp),window.removeEventListener("touchmove",this._onMove),window.removeEventListener("touchend",this._onUp)}}createRenderRoot(){return this}render(){const e=this._positions();return X`
      <div
    ...
    `}_renderRow(e,t){const s=this.store,r=Ye.trackById(e.id);if(!r)return X``;const a=Ye.albumById(r.albumId),o=s.selectedTracks.has(e.idxInQueue);return X`
      <hf-swipe-row
        .rowHeight=${56}
    ...
    `}_toggleSelectHass(e){const t=this.store.selectedTracks,s=new Set(t);s.has(e)?s.delete(e):s.add(e),this.store.setSelectedTracks(s)}_bulkRemoveHass(){const e=this.store.selectedTracks;this.store.removeQueueItems(new Set(e))}};yt.styles=l`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([ue({attribute:!1})],yt.prototype,"store",void 0),yt=e([ce("hf-queue-tab")],yt);let _t=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups,t=e.filter(e=>!e.isIdle),s=e.filter(e=>e.isIdle);return X`
      <div class="header">
    ...
    `}_renderGroupCard(e){const t=e.player?Ye.trackById(e.player.queue[e.player.currentIdx]??""):void 0,s=t?Ye.albumById(t.albumId):void 0,r=e.player?.groupVolume??e.lead.volume;return X`
  ...
  `,e([ue({attribute:!1})],_t.prototype,"store",void 0),_t=e([ce("hf-output-tab")],_t);const wt=l`
  .hf-pip {
    display: inline-flex;
    align-items: flex-end;
    gap: 1.5px;
...
`;let $t=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store.groups;return X`
      <div class="rail">
  ...
  `,e([ue({attribute:!1})],kt.prototype,"store",void 0),e([fe()],kt.prototype,"_draft",void 0),kt=e([ce("hf-group-sheet")],kt);const St=[{key:"hasMA",name:"Music Assistant",why:"Browses libraries (Spotify, Apple Music, Tidal, …), drives playback, and surfaces now-playing metadata.",hint:"Install the Music Assistant add-on, then add the integration under Settings → Devices & Services.",link:"https://music-assistant.io"},{key:"hasQueueActions",name:"Music Assistant Queue Actions (mass_queue)",why:"Adds queue manipulation services (reorder, remove, clear) the card uses on the Queue tab. Registers services under the mass_queue domain.",hint:'Install via HACS — "Music Assistant Queue Actions" by droans — then add it under Settings → Devices & Services.',link:"https://github.com/droans/mass_queue"},{key:"hasWiim",name:"WiiM Audio (LinkPlay)",why:"Provides WiiM-native Linkplay grouping. The card uses this for all multi-room sync, never MA grouping.",hint:'Install via HACS — "WiiM Audio Integration for Home Assistant" by mjcumming — then add each device under Settings → Devices & Services.',link:"https://github.com/mjcumming/wiim"}];let zt=class extends i{render(){if(!this.status)return X``;const e=St.filter(e=>!this.status[e.key]),t=e.length;return X`
    ...
    `],e([ue({attribute:!1})],zt.prototype,"status",void 0),zt=e([ce("hf-setup-help")],zt);let Mt=class extends i{constructor(){super(...arguments),this._pickerInitTriggered=!1}setConfig(e){this._config={...e}}updated(){!this._pickerInitTriggered&&this.hass&&this._config&&!customElements.get("ha-entity-picker")&&(this._pickerInitTriggered=!0,this._loadEntityPicker())}async _loadEntityPicker(){try{const e=await(window.loadCardHelpers?.());if(!e?.createCardElement)return;const t=await e.createCardElement({type:"entities",entities:[]}),s=t?.constructor;await(s?.getConfigElement?.())}catch(e){console.warn("[homefront-music-card] failed to load ha-entity-picker:",e)}finally{this.requestUpdate()}}render(){return this._config?X`
  ...
  `,e([ue({attribute:!1})],Mt.prototype,"hass",void 0),e([fe()],Mt.prototype,"_config",void 0),Mt=e([ce("hf-card-editor")],Mt);let At=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){return this.store&&0!==this.store.toasts.length?X`
      ${this.store.toasts.map(e=>X`
        ...
        `)}
    `:X``}_iconFor(e){return"error"===e?De.x({size:14,sw:2.4}):"warning"===e?De.filter({size:14}):De.note({size:14})}};At.styles=l`
    :host {
      position: absolute;
      left: 0;
      right: 0;
  ...
  `,e([ue({attribute:!1})],At.prototype,"store",void 0),At=e([ce("hf-toast-bar")],At),window.customCards=window.customCards||[],window.customCards.push({type:"homefront-music-card",name:"Homefront Music Card",description:"Music Assistant + WiiM multi-room controller",preview:!1});const It=[{id:"player",label:"Player",icon:"play"},{id:"browser",label:"Browse",icon:"home"},{id:"search",label:"Search",icon:"search"},{id:"queue",label:"Queue",icon:"queue"},{id:"group",label:"Output",icon:"speaker"}];let Ct=class extends i{constructor(){super(),this._store=new Store,new StoreController(this,this._store)}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e,this._store.setConfig(e),"panel"===e.layout?this.setAttribute("data-layout","panel"):this.removeAttribute("data-layout"),e.accent_color?(this.style.setProperty("--hf-accent",e.accent_color),this.style.setProperty("--hf-accent-text",function(e){const t=e.trim().replace(/^#/,"");if(3!==t.length&&6!==t.length)return"#fff";const s=3===t.length?t.split("").map(e=>e+e).join(""):t,r=parseInt(s.slice(0,2),16),a=parseInt(s.slice(2,4),16),o=parseInt(s.slice(4,6),16);if([r,a,o].some(e=>Number.isNaN(e)))return"#fff";const n=(.2126*r+.7152*a+.0722*o)/255;return n>.55?"#111":"#fff"}(e.accent_color))):(this.style.removeProperty("--hf-accent"),this.style.removeProperty("--hf-accent-text"));const t=e.density??"regular";this.setAttribute("data-density",t);const s=e.theme??"dark";this.setAttribute("data-theme",s)}willUpdate(e){e.has("hass")&&this.hass&&(this._integrationStatus=function(e){const t=e.services??{},s=e.states??{},r=[],a=t.music_assistant??{},o=t.mass_queue??{},n=t.wiim??{},l=!!a.play_media;r.push({target:"MA",label:"service music_assistant.play_media",matched:l});const d=["get_queue_items","remove_queue_item","move_queue_item_up","play_queue_item","clear_queue_from_here"],c=d.find(e=>!!o[e]),h=!!c;r.push({target:"QueueActions",label:`mass_queue domain has any of ${d.join(", ")}`,matched:h});const p=Object.keys(o);p.length>0&&r.push({target:"QueueActions",label:`mass_queue domain services found: ${p.slice(0,6).join(", ")}${p.length>6?"…":""}`,matched:!0});const u=["play_preset","play_url","set_eq","get_queue"],f=u.find(e=>!!n[e]),m=!!f;r.push({target:"WiiM",label:`wiim domain has any of ${u.join(", ")}`,matched:m});const v=Object.keys(n);v.length>0&&r.push({target:"WiiM",label:`wiim domain services found: ${v.slice(0,6).join(", ")}${v.length>6?"…":""}`,matched:!0});const g=Object.values(s).some(e=>{if(!e.entity_id.startsWith("media_player."))return!1;const t=e.attributes.group_role;return"master"===t||"slave"===t||"solo"===t});r.push({target:"WiiM",label:"any media_player.* attribute group_role is master/slave/solo",matched:g});const b=m||g;return{hasMA:l,hasQueueActions:h,hasWiim:b,allPresent:l&&h&&b,diagnostics:r}}(this.hass),this._integrationStatus.allPresent&&this._store.setHass(this.hass))}getCardSize(){return 12}static getConfigElement(){return document.createElement("hf-card-editor")}static getStubConfig(){return{type:"custom:homefront-music-card"}}disconnectedCallback(){super.disconnectedCallback(),this._store.dispose()}render(){return this._integrationStatus&&!this._integrationStatus.allPresent?X`<hf-setup-help .status=${this._integrationStatus}></hf-setup-help>`:X`
    ...
    `}_renderActiveTab(){switch(this._store.tab){case"player":return X`<hf-player-tab .store=${this._store}></hf-player-tab>`;case"browser":return X`<hf-browse-tab .store=${this._store}></hf-browse-tab>`;case"search":return X`<hf-search-tab .store=${this._store}></hf-search-tab>`;case"queue":return X`<hf-queue-tab .store=${this._store}></hf-queue-tab>`;case"group":return X`<hf-output-tab .store=${this._store}></hf-output-tab>`}}_renderTabBar(){return X`
      <div class="tab-bar" role="tablist">
        ${It.map(e=>{const t=this._store.tab===e.id;return X`
            <button
              class="tab"
              role="tab"
              aria-selected=${t}
    ...
    `],e([ue({attribute:!1})],Ct.prototype,"hass",void 0),e([fe()],Ct.prototype,"_config",void 0),e([fe()],Ct.prototype,"_integrationStatus",void 0),Ct=e([ce("homefront-music-card")],Ct);export{Ct as HomefrontMusicCard};
