...
`;function It(t,e={}){return(r={})=>{const s=r.size??20,a=r.stroke??"currentColor",o=r.sw??e.sw??1.7;return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${t} /></svg>`}}function Ct(t){return(e={})=>{const r=e.size??20,s=e.fill??"currentColor";return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill=${s} stroke="none"><path d=${t} /></svg>`}}const Pt={play:Ct("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(t={})=>{const e=t.size??20,r=t.fill??"currentColor";return X`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${r} stroke="none">
  ...
  `,t([ut({type:Number})],jt.prototype,"value",void 0),t([ut({type:Number})],jt.prototype,"min",void 0),t([ut({type:Number})],jt.prototype,"max",void 0),t([ut()],jt.prototype,"color",void 0),t([ut()],jt.prototype,"track",void 0),t([ut({type:Number,attribute:"track-height"})],jt.prototype,"trackHeight",void 0),t([ut({type:Number})],jt.prototype,"thumb",void 0),t([ut({attribute:"aria-label"})],jt.prototype,"ariaLabel",void 0),jt=t([ct("hf-slider")],jt);let Dt=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const t=this.store,e=t.currentTrack,r=t.currentAlbum,s=t.activePlayer,a=t.activeGroup,o=t.groups.filter(t=>!t.isActive&&t.playing).length,n=r.imageUrl;return X`
      <div class="art-wrap">
        <hf-album-art
          .obj=${r}
          size="100%"
  ...
  `,t([ut({attribute:!1})],Ft.prototype,"store",void 0),Ft=t([ct("hf-search-tab")],Ft);let Vt=class extends i{constructor(){super(...arguments),this.rowHeight=56,this.actionBg="#e0413a",this._dx=0,this._dragging=!1,this._startX=null,this._startDx=0,this._onDown=t=>{const e="touches"in t?t.touches[0].clientX:t.clientX;this._startX=e,this._startDx=this._dx,this._dragging=!0},this._onMove=t=>{if(null===this._startX)return;const e="touches"in t?t.touches[0].clientX:t.clientX;let r=this._startDx+(e-this._startX);r>0&&(r=0),r<-110&&(r=-110),this._dx=r},this._onUp=()=>{this._startX=null,this._dragging=!1,this._dx=this._dx<-64?-92:0},this._fireDelete=()=>{this.dispatchEvent(new CustomEvent("hf-delete",{bubbles:!0,composed:!0})),this._dx=0}}render(){return X`
      <div
        class="action"
  ...
  `,t([ut({type:Number})],Vt.prototype,"rowHeight",void 0),t([ut()],Vt.prototype,"actionBg",void 0),t([ut({attribute:!1})],Vt.prototype,"icon",void 0),t([ft()],Vt.prototype,"_dx",void 0),t([ft()],Vt.prototype,"_dragging",void 0),Vt=t([ct("hf-swipe-row")],Vt);let Yt=class extends i{constructor(){super(...arguments),this.items=[],this.rowHeight=56,this.renderRow=()=>X``,this._dragIdx=null,this._hoverIdx=null,this._startY=0,this._onMove=t=>{if(null===this._dragIdx)return;const e=("touches"in t?t.touches[0].clientY:t.clientY)-this._startY,r=Math.round(this._dragIdx+e/this.rowHeight);this._hoverIdx=Math.max(0,Math.min(this.items.length-1,r))},this._onUp=()=>{null!==this._dragIdx&&null!==this._hoverIdx&&this._hoverIdx!==this._dragIdx&&this.dispatchEvent(new CustomEvent("hf-reorder",{detail:{from:this._dragIdx,to:this._hoverIdx},bubbles:!0,composed:!0})),this._dragIdx=null,this._hoverIdx=null,window.removeEventListener("mousemove",this._onMove),window.removeEventListener("mouseup",this._onUp),window.removeEventListener("touchmove",this._onMove),window.removeEventListener("touchend",this._onUp)}}createRenderRoot(){return this}render(){const t=this._positions();return X`
      <div
  ...
  `,t([ut({attribute:!1})],Kt.prototype,"store",void 0),Kt=t([ct("hf-queue-tab")],Kt);let Jt=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const t=this.store.groups,e=t.filter(t=>!t.isIdle),r=t.filter(t=>t.isIdle);return X`
      <div class="header">
  ...
  `,t([ut({attribute:!1})],Jt.prototype,"store",void 0),Jt=t([ct("hf-output-tab")],Jt);const Xt=l`
  .hf-pip {
    display: inline-flex;
    align-items: flex-end;
    gap: 1.5px;
...
`;let Zt=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const t=this.store.groups;return X`
      <div class="rail">
  ...
  `,t([ut({attribute:!1})],te.prototype,"store",void 0),t([ft()],te.prototype,"_draft",void 0),te=t([ct("hf-group-sheet")],te);const ee=[{key:"hasMA",name:"Music Assistant",why:"Browses libraries (Spotify, Apple Music, Tidal, …), drives playback, and surfaces now-playing metadata.",hint:"Install the Music Assistant add-on, then add the integration under Settings → Devices & Services.",link:"https://music-assistant.io"},{key:"hasQueueActions",name:"Music Assistant Queue Actions (mass_queue)",why:"Adds queue manipulation services (reorder, remove, clear) the card uses on the Queue tab. Registers services under the mass_queue domain.",hint:'Install via HACS — "Music Assistant Queue Actions" by droans — then add it under Settings → Devices & Services.',link:"https://github.com/droans/mass_queue"},{key:"hasWiim",name:"WiiM Audio (LinkPlay)",why:"Provides WiiM-native Linkplay grouping. The card uses this for all multi-room sync, never MA grouping.",hint:'Install via HACS — "WiiM Audio Integration for Home Assistant" by mjcumming — then add each device under Settings → Devices & Services.',link:"https://github.com/mjcumming/wiim"}];let ie=class extends i{render(){if(!this.status)return X``;const t=ee.filter(t=>!this.status[t.key]),e=t.length;return X`
    ...
    `}_renderActiveTab(){switch(this._store.tab){case"player":return X`<hf-player-tab .store=${this._store}></hf-player-tab>`;case"browser":return X`<hf-browse-tab .store=${this._store}></hf-browse-tab>`;case"search":return X`<hf-search-tab .store=${this._store}></hf-search-tab>`;case"queue":return X`<hf-queue-tab .store=${this._store}></hf-queue-tab>`;case"group":return X`<hf-output-tab .store=${this._store}></hf-output-tab>`}}_renderTabBar(){return X`
      <div class="tab-bar" role="tablist">
        ${re.map(t=>{const e=this._store.tab===t.id;return X`
            <button
              class="tab"
              role="tab"
              aria-selected=${e}
