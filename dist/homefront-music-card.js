...
`;function Ie(e,t={}){return(s={})=>{const r=s.size??20,a=s.stroke??"currentColor",o=s.sw??t.sw??1.7;return X`<svg width=${r} height=${r} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${e} /></svg>`}}function Ce(e){return(t={})=>{const s=t.size??20,r=t.fill??"currentColor";return X`<svg width=${s} height=${s} viewBox="0 0 24 24" fill=${r} stroke="none"><path d=${e} /></svg>`}}const Ee={play:Ce("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(e={})=>{const t=e.size??20,s=e.fill??"currentColor";return X`<svg width=${t} height=${t} viewBox="0 0 24 24" fill=${s} stroke="none">
  ...
  `,e([ue({attribute:!1})],Qe.prototype,"obj",void 0),e([ue()],Qe.prototype,"size",void 0),e([ue({type:Number})],Qe.prototype,"radius",void 0),e([ue({attribute:!1})],Qe.prototype,"glyph",void 0),e([ue()],Qe.prototype,"boxShadow",void 0),e([ue({attribute:"image-url"})],Qe.prototype,"imageUrl",void 0),Qe=e([ce("hf-album-art")],Qe);let je=class extends i{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.color="#fff",this.track="rgba(255,255,255,0.18)",this.trackHeight=4,this.thumb=14,this.ariaLabel="",this._onInput=e=>{const t=Number(e.target.value);this.value=t,this.dispatchEvent(new CustomEvent("hf-input",{detail:t,bubbles:!0,composed:!0}))}}render(){const e=(this.value-this.min)/(this.max-this.min)*100;return this.style.setProperty("--hf-pct",`${e}%`),this.style.setProperty("--hf-color",this.color),this.style.setProperty("--hf-track",this.track),this.style.setProperty("--hf-track-h",`${this.trackHeight}px`),this.style.setProperty("--hf-thumb",`${this.thumb}px`),X`<input
      type="range"
      min=${this.min}
      max=${this.max}
  ...
  `,e([ue({type:Number})],je.prototype,"value",void 0),e([ue({type:Number})],je.prototype,"min",void 0),e([ue({type:Number})],je.prototype,"max",void 0),e([ue()],je.prototype,"color",void 0),e([ue()],je.prototype,"track",void 0),e([ue({type:Number,attribute:"track-height"})],je.prototype,"trackHeight",void 0),e([ue({type:Number})],je.prototype,"thumb",void 0),e([ue({attribute:"aria-label"})],je.prototype,"ariaLabel",void 0),je=e([ce("hf-slider")],je);let Ne=class extends i{willUpdate(e){e.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return X``;const e=this.store,t=e.currentTrack,s=e.currentAlbum,r=e.activePlayer,a=e.activeGroup,o=e.groups.filter(e=>!e.isActive&&e.playing).length,n=s.imageUrl;return X`
      <div class="art-wrap">
        <hf-album-art
          .obj=${s}
          size="100%"
