...
`;function It(t,e={}){return(r={})=>{const s=r.size??20,a=r.stroke??"currentColor",o=r.sw??e.sw??1.7;return J`<svg width=${s} height=${s} viewBox="0 0 24 24" fill="none" stroke=${a} stroke-width=${o} stroke-linecap="round" stroke-linejoin="round"><path d=${t} /></svg>`}}function Ct(t){return(e={})=>{const r=e.size??20,s=e.fill??"currentColor";return J`<svg width=${r} height=${r} viewBox="0 0 24 24" fill=${s} stroke="none"><path d=${t} /></svg>`}}const Pt={play:Ct("M7 5.5v13a1 1 0 0 0 1.55.83l10-6.5a1 1 0 0 0 0-1.66l-10-6.5A1 1 0 0 0 7 5.5z"),pause:(t={})=>{const e=t.size??20,r=t.fill??"currentColor";return J`<svg width=${e} height=${e} viewBox="0 0 24 24" fill=${r} stroke="none">
  ...
  `,t([ut({type:Number})],Ot.prototype,"value",void 0),t([ut({type:Number})],Ot.prototype,"min",void 0),t([ut({type:Number})],Ot.prototype,"max",void 0),t([ut()],Ot.prototype,"color",void 0),t([ut()],Ot.prototype,"track",void 0),t([ut({type:Number,attribute:"track-height"})],Ot.prototype,"trackHeight",void 0),t([ut({type:Number})],Ot.prototype,"thumb",void 0),t([ut({attribute:"aria-label"})],Ot.prototype,"ariaLabel",void 0),Ot=t([ct("hf-slider")],Ot);let jt=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){if(!this.store)return J``;const t=this.store,e=t.currentTrack,r=t.currentAlbum,s=t.activePlayer,a=t.activeGroup,o=t.groups.filter(t=>!t.isActive&&t.playing).length;return J`
      <div class="art-wrap">
        <hf-album-art
          .obj=${r}
          size="100%"
  ...
  `,t([ut({attribute:!1})],jt.prototype,"store",void 0),jt=t([ct("hf-player-tab")],jt);const Dt=[{id:"playlists",label:"Playlists"},{id:"albums",label:"Albums"},{id:"artists",label:"Artists"},{id:"tracks",label:"Tracks"},{id:"radio",label:"Radio"}];let Nt=class extends i{willUpdate(t){t.has("store")&&this.store&&!this._ctrl&&(this._ctrl=new StoreController(this,this.store))}render(){return this.store?J`${this._renderCrumbs()} ${this._renderBody()}`:J``}_renderCrumbs(){const t=this.store.browser.crumbs;return J`
      <div class="crumbs">
